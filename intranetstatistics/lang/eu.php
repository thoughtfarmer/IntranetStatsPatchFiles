...
Konturatu ez dela beharrezkoa URLak \'www\'-rekin edo gabe zehaztea, Intranet Statistics-ek automatikoki biak hartzen baititu kontuan.',
	'SitesManager_Id' => 'Id',
	...
	'Installation_NoConfigFound' => 'Intranet Statistics konfigurazio-fitxategia ezin izan da aurkitu eta Intranet Statistics orri bat atzitzen saiatzen ari zara.<br /><b>&nbsp;&nbsp;&raquo; <a href=\'index.php\'>Intranet Statistics orain instalatu</a> dezakezu</b><br /><small>Aurretik Intranet Statistics instalatu eta datu-basean taulak badituzu, ez kezkatu, taula berdinak berrerabil ditzakezu eta dauden datuak mantendu!</small>',
	...
	'Installation_ConnectionCharacterSetNotUtf8' => 'Datu-base zerbitzarirako konexioa ez dago UTF8 bezala lehenetsita. Ez da hil ala biziko arazoa: <b>Intranet Statistics-ek ondo funtzionatu behar luke</b>. Halere, konsistentzia mantentzeagatik, ondorengoetako bat egitea gomendatzen da: <ul style="list-style: disc;margin-left:10px"><li>Zure Intranet Statistics konfigurazio-fitxategian <code>config/config.ini.php</code>, <code>charset = utf8</code> gehitzea [database] atalean</li><li>libmysql --with-charset=utf8 aukerarekin birkonpilatzea</li></ul>',
	...
	'Installation_JsTagHelp' => '<p>Bisitari guztiak kontatzeko, JavaScript kodea txertatu behar duzu zure orri guztietan.</p><p>Zure orriek ez dute PHPz eginak izan behar, Intranet Statistics ondo moldatuko da mota guztietako orrietan (HTML, ASP, Perl edo beste edozein lengoaiakoak izanda ere).</p><p>Hemen da txertatu behar duzun kodea: (kopiatu eta itsatsi zure orri guztietan)</p>',
	...
	'Installation_JsTagArchivingHelp' => 'Trafiko ertain eta handiko webguneetarako, eman begirada <a target="_blank" href="http://piwik.org/docs/setup-auto-archiving/">Nola konfiguratu artxibatze automatikoko orria</a> dokumentuari Intranet Statistics azkar batean exekuta dadin!',
