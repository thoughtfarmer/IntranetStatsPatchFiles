...
$translations = array(
	...
	'Core_ExceptionDatabaseVersion' => 'Вие използвате %s версия %s , но Intranet Statistics изисква да използвате последната версия%s.',
	...
	'CoreUpdater_TheUpgradeProcessMayFail' => 'Ако е голяма Intranet Statistics базата от данни (БД), обновяването може да отнеме по-дълго време от стандартното. Ако желаете обновяването да е по-бързо можете да обновите, чрез командния ред така (само за напреднали): <code>$ php път/до/piwik/index.php</code>',
...
Забележка: този token ще изтече след 24 часа.',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Анонимният потребител не може да бъде редактиран или изтрит. Intranet Statistics по този начин дефинира в система потребители, които не са влезли. Например можете да направите данните на брояча ви публични, като зададете \'view\' права на \'anonymous\' потребител.',
	...
	'Installation_NoConfigFound' => 'Intranet Statistics конфигурационният файл не е открит.<br /><b>&nbsp;&nbsp;&raquo; Можете да <a href=\'index.php\'>инсталирате Intranet Statistics сега</a></b><br /><small>Ако преди това сте инсталирали Intranet Statistics и имате в базата от данни (БД) таблици - можете да запазите Вашите данни!</small>',
	...
	'Installation_JsTagHelp' => '<p>За да се отчитат всички посетители, трябва JavaScript кода да е добавен във всички страници на вашия сайт.</p><p>Вашият сайт не е необходимо да е разработен на PHP, Intranet Statistics работи на всички платформи и езици (независимо какво използвате: HTML, ASP, Perl или някой друг език и/или технология).</p><p>Това е кода, който трябва да добавите: (копирайте и го поставете във всички страници на сайта) </p>',
	'Installation_JsTagQuicHelpk' => 'Бърза помощ',
	'Installation_JsTagArchivingHelp' => 'За средно и силно натоварените сайтове, вижте: <a target="_blank" href="http://piwik.org/docs/setup-auto-archiving/">Какви настройки да използваме за архивиране на данните</a> за да заема по-малко ресурси Intranet Statistics и работи по-бързо!',
...
във Вашия php.ini, добавете следните редове: %2$s',
	...
	'ExamplePlugin_blogPiwikRss' => 'RSS от блога на Intranet Statistics',
	...
	'Widgetize_PluginDescription' => 'Този плъгин прави много лесен за износ на всяка Intranet Statistics джаджа във вашия блог, уеб сайт или по Igoogle и Netvibes!',
