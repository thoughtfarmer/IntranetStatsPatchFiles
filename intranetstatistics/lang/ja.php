...
$translations = array(
	...
	'General_Error' => 'エラー',
	'General_Warning' => '警告',
	'General_BackToHomepage' => 'Intranet Statistics ホームページへ戻る',
	'General_Yes' => 'はい',
	'General_No' => 'いいえ',
	'General_Delete' => '削除',
	'General_Edit' => '編集',
	...
	'General_PiwikIsACollaborativeProject' => '%s Intranet Statistics %s は共同プロジェクトであり、まだベータです。 %s 手伝いたいとお考えでしたら、%s私たちと連絡を取ってください！%s',
	'CorePluginsAdmin_Plugins' => 'プラグイン',
	'CorePluginsAdmin_PluginsManagement' => 'プラグインの管理',
	'CorePluginsAdmin_MainDescription' => 'プラグインは Intranet Statistics の機能性を拡張します。 プラグインをインストールした時点で、ここで有効化と無効化をすることができます。',
	...
	'API_QuickDocumentation' => '<h2>API クイックドキュメント</h2><p>今日のデータがない場合、ビジット生成スクリプトを使用して、はじめに<a href=\'misc/generateVisits.php\' target=_blank>若干のデータを生成</a>することができます。</p><p>あらゆる方法に対して、利用可能な異なる形式を試すことができます。 あなたの望むあらゆるデータを Intranet Statistics から抽出するのはとても簡単です！</p><p><b>より詳細な情報については、<a href=\'http://dev.piwik.org/trac/wiki/API\'>公式 API ドキュメント</a>や<a href=\'http://dev.piwik.org/trac/wiki/API/Reference\'>API リファレンス</a>を参照してください。</b></P><h2>ユーザ認証</h2><p><b>あなたのスクリプトでデータを要求（crontab などで）したい場合、</b>認証を必要とする API コールの URL にパラメータ <code><u>&token_auth=%s</u></code> を付加する必要があります。</p><p>この token_auth はログインやパスワードと同じくらい機密です。 決して共有しないでください！</p>',
	'API_LoadedAPIs' => '%s の API が正常に読み込まれました',
	'CoreHome_NoPrivileges' => 'あなたは \'%s\' としてログインしていますが、Intranet Statistics でのいかなるパーミッションも持っていないようです。 <br />あなたにウェブサイトへの「表示」アクセス権を与えるよう、Intranet Statistics 管理者に依頼してください。',
	...
	'CoreUpdater_UpdateTitle' => 'Intranet Statistics &rsaquo; 更新',
	'CoreUpdater_UpdateRequired' => 'アップグレードが必要です',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'あなたの Intranet Statistics データベースは旧式で、継続する前にアップグレードが必要です。',
	'CoreUpdater_PiwikWillBeUpgradedToVersionX' => 'Intranet Statistics はバージョン %s へアップグレードされます。',
	...
	'UsersManager_MainDescription' => '各ユーザのウェブサイト上での Intranet Statistics アクセス権を決定します。  また、全ウェブサイトのパーミッションを一度に設定することもできます。',
	...
	'UsersManager_ExceptionEditAnonymous' => 'anonymous ユーザは、ログインしていないユーザの定義のために Intranet Statistics が使用するため、編集や削除はできません。 例えば、\'anonymous\' ユーザへ「表示」アクセスを許可することで、統計を公共にすることができます。',
	...
	'Installation_NoConfigFound' => 'Intranet Statistics 設定ファイルが見つからず、あなたは Intranet Statistics ページにアクセスしようとしています。<br /><b>&nbsp;&nbsp;&raquo; <a href=\'index.php\'>ただちに Intranet Statistics をインストール</a>することができます。</b><br /><small>以前に Intranet Statistics をインストールし、DB に若干のデータがある場合でも心配しないでください。 同じテーブルを再利用し、既存のデータを保持することができます！</small>',
	...
	'Installation_JsTagHelp' => '<p>すべての訪問者を数えるには、すべてのページに javascript コードを挿入する必要があります。</p><p>ページが PHP である必要はありません。 Intranet Statistics は、あらゆる種類（HTML、ASP、Perl、あるいはそれ以外の言語）のページで動作します。</p><p>挿入するコードは以下のとおりです： （すべてのページにコピー＆ペーストしてください）</p>',
	'Installation_Congratulations' => 'おめでとう',
	'Installation_CongratulationsHelp' => '<p>おめでとうございます！ Intranet Statistics のインストールは完了しました。</p><p>javascript コードをページに記入したことを確認し、最初の訪問者をお待ちください！</p>',
	'Installation_GoToPiwik' => 'Intranet Statistics へ行く',
	...
	'Installation_TablesWarning' => 'いくつかの <span id="linkToggle">Intranet Statistics テーブル</span>が、すでに DB にインストール済みです',
	...
	'Installation_TablesDeleteConfirm' => '本当に、このデータベースから Intranet Statistics の全テーブルを削除してもよろしいですか？',
	...
	'DBStats_MainDescription' => 'Intranet Statistics はすべてのウェブ分析データを Mysql データベースに保存します。  現在、Intranet Statistics テーブルは %s を使用中です。',
	'DBStats_Table' => 'テーブル',
