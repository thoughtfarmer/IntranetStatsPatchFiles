...
$translations = array(
	...
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Je k dispozici Intranet Statistics %1$s. %2$s Prosím aktualizujte jej!%3$s (viz %4$s změny%5$s).',
	...
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Vaše databáze Intranet Statisticsu jw zastaralá a musí být aktualizována než budete pokračovat.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Databáze Intranet Statisticsu bude aktualizována z verze %1$s na novou verzi %2$s.',
	...
	'CoreUpdater_HelpMessageContent' => 'Zkontrolujte %1$s Intranet Statistics FAQ %2$s , který vysvětluje nejčastějsí chybi při aktualizaci. %3$s Požádejte vašeho systémového administrátora - může vám pomoct s chybou, která je nejčastěji způsobena nastavením serveru MySQL.',
	...
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'One Click aktualizace Intranet Statisticsu byla stornována. Pokud nemůžete opravit chybu je doporučeno Intranet Statistics aktualizovat manuálně. %1$s Prosím zkontrolujte pro začátek %2$sDokumentaci k aktualizaci%3$s!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics aktualizován úspěšně!',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Anonymous uživatel nemůže být upraven, nebo vymazán. Je použit Intranet Statisticsem k definici uživatele, který ještě není přihlášen. Na příklůad můžete zveřejnit vaše statistiky udělením oprávnění \'view\' uživateli \'anonymous\'.',
	'UsersManager_ExceptionSuperUser' => 'Požadovaný uživatel je Super uživatele a nemůže být dotazován, upravován, nebo mazán pomocí API. Musíte jej ručně upravit v konfiguračním souboru Intranet Statistics..',
	...
	'Installation_NoConfigFound' => 'Konfigurační soubor Intranet Statisticsu nebyl nalezen a snažíte se vstoupit na stránku Intranet Statisticsu.<br /><b>&nbsp;&nbsp;&raquo; Můžete <a href=\'index.php\'>teď nainstalovat</a></b><br /><small>Pokud jste Intranet Statistics již instalovali a máte v DB nějaké tabulky, nebojte se. Můžete je použít a zachovat jejich data.!</small>',
	...
	'Installation_JsTagHelp' => '<p>Pro spočítání všech návštěvníku musíte vložit JavaScriptový kód na všechny stránky.</p><p>Vaše stránky nemusí být napsané v PHP., Intranet Statistics pracuje na všech typech stránek(ať je to HTML, ASP, Perl nebo jakýkoliv jiný jazyk).</p><p>Tady je kód, který musíte vložit: (zkopírujte a vložte na všechny vaše stránky) </p>',
	...
	'Installation_SecurityNewsletter' => 'pošli mi e-mail při hlavních aktualizacích a bezpečnostních oznámeních Intranet Statisticsue',
	...
	'Installation_TablesWithSameNamesFound' => 'Některé %1$s tabulky ve vaší databázi %2$s mají stejná jména jako tabulky, které se snaží vytvořit Intranet Statistics',
	...
	'Installation_ErrorInvalidState' => 'Chyba: zdá se, že se snažíte přeskočit krok instalace, nebo máte zakázány cookies, nebo již je konfigurační soubor Intranet Statisticsu vytvořen. %1$sUjistěte se, že máte povoleny cookies%2$s a vraťte se zpět %3$s na první stránku instalace %4$s.',
