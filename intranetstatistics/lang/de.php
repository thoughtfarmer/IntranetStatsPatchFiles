...
$translations = array(
	...
	'CoreAdminHome_PluginDescription' => 'Intranet Statistics Einstellungen',
	...
	'CorePluginsAdmin_MainDescription' => 'Plugins erweitern die Funktionalität von Intranet Statistics. Installierte Plugins können hier aktiviert oder deaktiviert werden.',
	...
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Ihre Intranet Statistics-Datenbank ist nicht mehr aktuell und muss aktualisiert werden, bevor Sie weiter damit arbeiten können.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Mit der Intranet Statistics-Datenbank wird ein Upgrade von Version %1$s auf die neue Version %2$s durchgeführt.',
	...
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Eine neue Version von Intranet Statistics ist als Update verfügbar',
	...
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Das Intranet Statistics Ein-Klick-Update wurde abgebrochen. Wenn die oben stehende Fehlermeldung nicht behoben werden kann, empfehlen wir Ihnen, ein manuelles Update von Intranet Statistics durchzuführen. %1$s Bitte die %2$sUpdate-Dokumentatierung%3$s ansehen, um loszulegen!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Es wurde erfolgreich ein Update von Intranet Statistics durchgeführt!',
	'CoreUpdater_PluginDescription' => 'Intranet Statistics Update',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Wichtiger Hinweis für große Intranet Statistics Installationen',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Wenn Sie eine große Intranet Statistics Datenbank haben, können Updates zu lange dauern um erfolgreich im Browser durchgeführt zu werden. In solch einem Fall können Sie das Update von der Kommandozeile aus starten: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Wenn Sie nicht das Update von der Kommandozeile aus ausführen können und Intranet Statistics den Update nicht durchführen kann (wegen Zeitüberschreitungen der Datenbank, des Browser oder sonstigen Fällen), können Sie die SQL-Kommandos manuell ausführen.',
	...
	'DBStats_PluginDescription' => 'Dieses Plugin berichtet über die Nutzung und Auslastung der Intranet Statistics Tabellen.',
	'DBStats_LearnMore' => 'Um mehr darüber zu erfahren wie Intranet Statistics Daten verarbeitet und wie sie dies auf stark besuchten Webseiten handhaben können, schauen Sie in die Dokumentation unter: %s.',
	...
	'ExamplePlugin_blogPiwikRss' => 'Intranet Statistics Blog RSS',
	...
	'Feedback_PluginDescription' => 'Senden Sie Ihr Feedback an das Intranet Statistics Team. Teilen Sie Ihre Ideen, Anforderungen und Wünsche mit uns!',
	...
	'Feedback_WhyWrongCountry' => 'Warum zeichnet Intranet Statistics meine Zugriff aus einem fremden Land auf?',
	...
	'Feedback_CategoryHire' => 'Fragen Sie einen Intranet Statistics Berater an',
	...
	'Installation_NoConfigFound' => 'Die Intranet Statistics-Konfigurationsdatei konnte nicht gefunden werden und es wird versucht, eine Intranet Statistics-Seite aufzurufen.<br /><b>&nbsp;&nbsp;&raquo; Sie können <a href=\'index.php\'>Intranet Statistics jetzt installieren</a></b><br /><small>Wenn Sie Intranet Statistics zuvor schon installiert haben und noch Tabellen in der Datenbank vorhanden sind: Keine Angst, Sie können diese Tabellen und die enthaltenen Daten weiterhin verwenden!</small>',
	...
	'Installation_JsTagHelp' => '<p>Um alle Besucher zählen zu können, muss der Javascript-Code auf jeder Seite eingebaut werden.</p><p>Es muss sich nicht um eine PHP-Seite handeln, da Intranet Statistics auch mit HTML, ASP, Perl, etc. funktioniert.</p><p>Hier ist der Code, welcher eingefügt werden muss (Copy & Paste): </p>',
	...
	'Installation_SecurityNewsletter' => 'Senden Sie mir wichtige Updates von Intranet Statistics und Sicherheitswarnungen per E-Mail',
	...
	'Installation_TablesDeletedSuccess' => 'Vorhandene Intranet Statisticstabellen wurden entfernt',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics ist eine freiverfügbare Analyse-Software um einfach Informationen über die Besucher Ihrer Webseite zu erhalten.</p><p>Der Prozess teilt sich in %s einfache Schritte und wird rund 5 Minuten dauern.</p>',
	...
	'Installation_SystemCheckParseIniFileHelp' => 'Diese Funktion wird von Ihrem System nicht unterstützt. Intranet Statistics wird versuchen diese Funktion nach zu ahmen, aber es könnte sein, dass daduruch Sicherheitseinstellungen gelockert werden müssen. Die Geschwindigkeit des Tracker könnte auch beeinflußt werden.',
	...
	'Login_ContactAdmin' => 'Möglicher Grund: Der Server könnte die mail()-Funktion abgeschaltet haben.<br/>Bitte sprechen Sie mit Ihrem Intranet Statistics-Administrator.',
	...
	'UsersManager_MainDescription' => 'Hier kann Zugriff auf bestimmte Webseiten innerhalb von Intranet Statistics erteilt werden. Es ist auch möglich Zugriff für alle Webseiten auf einmal zu setzen.',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Der anonyme Benutzer kann nicht bearbeitet oder gelöscht werden. Er wird von Intranet Statistics benutzt um einen Benutzer zu simulieren, der sich noch nicht angemeldet hat. Zum Beispiel könnte das Statistik-Plugin öffentlich gemacht werden, indem dem Benutzer \'anonymous\' das Recht \'view\' dafür vergeben würde.',
	'UsersManager_ExceptionSuperUser' => 'Der angeforderte Benutzer ist der Super-Benutzer und kann über das API nicht angefragt, editiert oder gelöscht werden. Die Angaben zum Super-Benutzer können in der Intranet Statistics-Konfigurationsdatei manuell editiert werden.',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Intranet Statistics erlauben, die Archivierung zu starten, wenn Berichte vom Browser angezeigt werden.',
	...
	'General_ConfigFileIsNotWritable' => 'Die Intranet Statistics-Konfigurationsdatei %s ist nicht beschreibbar, Ihre Änderungen werden nicht gespeichert. %s Bitte ändern Sie die Zugriffsrechte der Konfigurationsdatei, um diese beschreibbar zu machen.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => 'Intranet Statistics filtert automatisch typische session parameter (%s).',
	'SitesManager_HelpExcludedIps' => 'Geben Sie eine Liste von IPs an, eine pro Zeile, welche von Intranet Statistics beim Erfassen von Besuchen ignoriert werden sollen. Es können Wildcards genutzt werden, z.B. %1$s oder %2$s',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%sIhre Besuche werden von Intranet Statistics unter der Addresse %s ignoriert %s (das Intranet Statistics Cookie zum Ignorieren von Besuchen wurde in Ihrem Browser gefunden).',
	...
	'UsersManager_ClickHereToSetTheCookieOnDomain' => 'Klicken Sie hier um eine Cookie zu setzen, welches Ihre Besuche auf Seiten die von Intranet Statistics unter %s gezählt werden zu ignorieren',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Wenn Benutzer nicht eingeloggt sind und Intranet Statistics besuchen, sollten sie weitergeleitet werden auf',
	...
	'API_GenerateVisits' => 'Sollten Sie keine Daten für heute haben, so können Sie mit dem %s Plugin welche erzeugen. Sie können das %s Plugin aktivieren, klicken Sie dann auf das \'Besuchergenerator\' Menu in der Intranet Statistics Administration.',
	'API_MoreInformation' => 'Für mehr Informationen über die Intranet Statistics APIs, lesen Sie %s Einführung in die Intranet Statistics API %s und die %s Intranet Statistics API Referenz %s.',
	...
	'VisitorGenerator_PluginDescription' => 'Plugin mit dem gefälschte Besucherzahlen generiert werden können. Dies kann von Intranet Statistics Benutzern und Entwicklern genutzt werden um gefälschte Daten zu erzeugen die die Berichte füllen.',
	'VisitorGenerator_VisitorGenerator' => 'Besuchergenerator',
	'VisitorGenerator_Warning' => 'Sie sind kurz davor gefälsche Besucherzahlen zu generieren, welche in der Intranet Statistics-Datenbank gespeichert werden.',
	'VisitorGenerator_NotReversible' => 'Es wird %s nicht%s einfach möglich sein diese Besuche aus den Intranet Statistics-Logs zu löschen.',
	...
	'General_YouAreViewingDemoShortMessage' => 'Sie betrachten gerade die Demo von Intranet Statistics',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics kann Ihre aktuelle Installation nicht überschreiben. Sie können entweder die Ordner-/Dateiberechtigungen anpassen oder das Paket herunterladen und die Version %s manuell installieren.',
	...
	'Installation_SystemCheckAutoUpdateHelp' => 'Hinweis: Intranet Statistics\'s Ein-Klick-Update benötigt Schreibrechte für den Intranet Statistics Ordner und dessen Inhalt.',
