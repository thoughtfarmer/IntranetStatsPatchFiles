...
$translations = array(
	...
	'Core_ExceptionDatabaseVersion' => '%s versio on %s mutta Intranet Statistics tarvitsee vähintään version %s.',
	...
	'CoreHome_NoPrivileges' => 'Olet kirjautunut sisään käyttäjänä %s, mutta sinulla ei ole mitään oikeuksia Intranet Statisticsiin.<br />Pyydä oman Intranet Statisticsisi ylläpitäjää antamaan katseluoikeus sivustoon.',
	...
	'CoreUpdater_UpdateTitle' => 'Intranet Statistics &rsaquo; Päivitys',
	...
	'CoreUpdater_TheUpgradeProcessMayFail' => 'Jos Intranet Statistics-tietokantasi on iso, päivitys saattaa kestää liian kauan. Jos yhteys aikakatkaistaan, voit ajaa päivityksen komentoriviltä komennolla <cod$ php path/to/piwik/index.php</code>.',
	...
	'Installation_JsTagHelp' => '<p>Lisää tämä koodi kaikille sivuillesi laskeaksesi kävijät.</p><p>Sivujen ei tarvitse olla tehty PHP:llä. Intranet Statistics toimii kaikilla sivuilla (esim. HTML, ASP, Perl tai mikä tahansa muu kieli).</p><p>Tässä on koodi, joka sivuille pitää lisätä: (kopioi ja liitä kaikille sivuille)</p>',
	'Installation_JsTagQuicHelpk' => 'Pikaopas',
	'Installation_JsTagArchivingHelp' => 'Korkean liikenteen sivuille on suositeltavaa <a target="_blank" href="http://piwik.org/docs/setup-auto-archiving/">ottaa käyttöön arkistointi</a>, jotta Intranet Statistics toimisi nopeasti.',
...
Lisää php.ini-tiedostoon seuraavat rivit: %2$s',
	...
	'Goals_NoGoalsNeedAccess' => 'Vain ylläpitäjä voi lisätä tavoitteita tälle sivulle. Pyydä Intranet Statistics-sivusi ylläpitäjää luomaan tavoite sivulle.<br/>
...
Tavoitteet ovat hyvä tapa ymmärtää ja maksimoida verkkosivujesi tehokkuus!',
	...
	'Mobile_AccessUrlLabel' => 'Intranet Statisticsin hallintaosoite',
	...
	'ExamplePlugin_blogPiwikRss' => 'Intranet Statisticsin blogin RSS',
	...
	'VisitorGenerator_Warning' => 'Olet luomassa valheellisia käyntejä, jotka tallennetaan Intranet Statisticsin tietokantaan.',
