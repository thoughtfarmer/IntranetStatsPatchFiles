...
$translations = array(
	...
	'General_ArchivingInlineHelp' => 'Pour les sites à trafic moyen et fort il est recommandé de désactiver l\'archivage de Intranet Statistics depuis le navigateur. Nous vous recommandons de mettre en place une tâche planifiée (cron) qui génère les rapports toutes les heures.',
	...
	'General_RequiresFlash' => 'L\'affichage des graphs dans Intranet Statistics requiert Flash',
	'General_GraphHelp' => 'Plus d\'informations à propos de l\'affichage des graphs dans Intranet Statistics.',
	...
	'General_FileIntegrityWarningExplanation' => 'Le contrôle d\'intégrité a échoué et a rapporté des erreurs. Cela est probablement du à un envoi de fichier partiel ou en échec des fichiers de Intranet Statistics. Vous devriez envoyer de nouveau les fichiers de Intranet Statistics et rafraichir cette page jusqu\'à ce qu\'elle n\'affiche plus aucune erreur.',
	...
	'CoreHome_NoPrivileges' => 'Vous êtes connecté en tant que \'%s\' mais vous n\'avez apparemment aucune permission de définie dans Intranet Statistics.<br />Demandez à votre administrateur Intranet Statistics de vous donner l\'accès \'voir\' à un site web.',
	...
	'ExampleUI_PluginDescription' => 'Plugin d\'exemple: Ce plugin montre comment fonctionne l\'interface utilisateur de Intranet Statistics: création de tables, graphs, etc.',
	'Feedback_PluginDescription' => 'Envoie vos retours à l\'Equipe Intranet Statistics. Partagez vos idées et suggestions avec nous!',
	...
	'Feedback_SpecialRequest' => 'Avez vous une demande spéciale pour l\'Equipe Intranet Statistics? ',
	'Feedback_ContactThePiwikTeam' => 'Contactez l\'Equipe Intranet Statistics!',
	...
	'Feedback_MessageSent' => 'Votre message a été envoyé à l\'Equipe Intranet Statistics.',
	'Feedback_ThankYou' => 'Merci d\'avoir aidé à améliorer Intranet Statistics!',
	'Feedback_ThePiwikTeam' => 'L\'Equipe Intranet Statistics',
	...
	'Installation_JsTagArchivingHelp' => 'Pour les sites à moyen et fort trafic, lisez <a target="_blank" href="http://piwik.org/docs/setup-auto-archiving/">la page d\'explication sur comment mettre en place une page d\'auto archivage</a> pour que Intranet Statistics devienne réellement rapide!',
 ...
 Dans votre php.ini, ajoutez les lignes suivantes: %2$s',
	...
	'Installation_SystemCheckProtocolHelp' => 'Si Intranet Statistics se situe derrière un proxy inversé ajoutez ces lignes dans config/config.ini.php sous la section [General]:',
	...
	'LanguagesManager_AboutPiwikTranslations' => 'A propos des traductions de Intranet Statistics',
	...
	'SitesManager_AliasUrlHelp' => 'Il est recommandé, mais pas requis, de spécifier les URL différentes que vos utilisateurs utilisent pour accéder au site web. Les URL d\'alias pour un site n\'apparaitront pas dans Référents > Sites Internet. Il n\'est pas nécessaire d\'entrer les URL avec et sans les www, Intranet Statistics les traite automatiquement.',
	'SitesManager_Id' => 'Id',
	...
	'UsersManager_YourVisitsAreIgnored' => '%sVos visites sont ignorées par Intranet Statistics%s (le cookie d\'exclusion de Intranet Statistics a été trouvé sur votre navigateur).',
	...
	'UsersManager_ClickHereToSetTheCookie' => 'Cliquez ici pour mettre en place un cookie qui permettra à Intranet Statistics d\'ignorer vos visites sur vos sites',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Quand les utilisateurs ne sont pas connectés et accèdent à Intranet Statistics, il verront',
	...
	'VisitTime_NHour' => '%sh',
	'Widgetize_PluginDescription' => 'Le plugin rend l\'export de n\'importe quel Widget Intranet Statistics dans votre blog, site web ou sur Igoogle et Netvibes!',
	...
	'ExamplePlugin_blogPiwikRss' => 'Flux RSS du blog Intranet Statistics',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics ne peut pas écraser votre installation courante.
