...
$translations = array(
	...
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'La versione %1$s di Intranet Statistics &egrave; disponibile. %2$s Aggiorna ora!%3$s (%4$svedi le modifiche%5$s).',
	...
	'General_RequiresFlash' => 'Per vedere i grafici in Intranet Statistics &egrave; richiesto Flash',
	'General_GraphHelp' => 'Maggiori informazioni su come vedere grafici in Intranet Statistics.',
	'General_ExceptionDatabaseVersion' => 'La tua %1$s versione &egrave; %2$s ma Intranet Statistics ha bisogno di almeno %3$s.',
	...
	'CoreHome_NoPrivileges' => 'Ti sei autenticato come "%s" ma sembra che tu non abbia alcun permesso per operare in Intranet Statistics.<br />Chiedi all\'amministratore di sistema di assegnarti i permessi di tipo "view" per accedere alle statistiche.',
	...
	'CorePluginsAdmin_MainDescription' => 'I Plugins estendono le funzionalit&agrave; di Intranet Statistics. Una volta installati, &egrave; possivile attivarli o disattivarli qui (non tutti sono in italiano).',
	...
	'CoreUpdater_UpdateTitle' => 'Intranet Statistics &rsaquo; Aggiornamenti',
	'CoreUpdater_DatabaseUpgradeRequired' => 'Aggiornamento del Database richiesto',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Il tuo Database Intranet Statistics &egrave; obsoleto e deve essere aggiornato prima di continuare.',
	...
	'CoreUpdater_HelpMessageContent' => 'Controlla le %1$s Intranet Statistics FAQ %2$s, ti spiegheranno gli errori pi&ugrave; comuni durante l\'aggiornamento. %3$s Chiedi all\'amministratore di sistema per gli errori che ti sembrano relativi alla configurazione di MySQL o al server, piuttosto che a Intranet Statistics.',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics &egrave; stato aggiornato con successo!',
	'CoreUpdater_ContinueToPiwik' => 'Vai a Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => 'Aggiorna automaticamente',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'C\'&egrave; una nuova versione di Intranet Statistics disponibile per l\'aggiornamento.',
	...
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Il "Intranet Statistics One Click Update" &egrave; stato cancellato. Se non riesci a sistemare il problema causato dal messaggio di errore indicato, &egrave; consigliabile aggiornare manualmente Intranet Statistics. %1$s Controlla il %2$sManuale di aggiornamento%3$s per iniziare!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics &egrave; stato aggiornato con successo!',
	...
	'CoreUpdater_ErrorDIYHelp_5' => 'riporta l\'errore (e la soluzione) cos&igrave; che Intranet Statistics possa migliorare',
	...
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'La tua versione di Intranet Statistics %s &egrave; aggiornata.',
	...
	'ExamplePlugin_blogPiwikRss' => 'RSS del Blog Intranet Statistics',
	...
	'Feedback_WhyWrongCountry' => 'Perch&egrave; Intranet Statistics mostra le mie visite dallo stato sbagliato?',
	...
	'Feedback_MessageSent' => 'Il tuo messaggio &egrave; stato inviato al team Intranet Statistics.',
	...
	'Goals_NoGoalsNeedAccess' => 'Solo un Amministratore o il Super Utente possono aggiungere Obiettivi per un sito. Chiedi a tuo amministratore di Intranet Statistics di settare un Obiettivo per il tuo sito.<br/>
...
Tracciare gli obiettivi &egrave; un ottimo aiuto per capire e massimizzare le prestazioni del tuo sito!',
	...
	'Goals_DefaultRevenueHelp' => 'Per esempio, un Form di Contatto inviato da un visitatore pu&ograve; valere mediamente $10. Intranet Statistics pu%ograve; aiutarti a capire quanto rendono i tuoi visitatori.',
	...
	'Installation_NoConfigFound' => 'Il file di configurazione di Intranet Statistics non &egrave; stato trovato e stai tentando l\'accesso ad una pagina di Intranet Statistics.<br /><b>&nbsp;&nbsp;&raquo; Puoi <a href=\'index.php\'>installare Intranet Statistics ora.</a></b><br /><small>Se hai gi&agrave; installato in precedenza Intranet Statistics e nel tuo Database sono presenti delle tabelle della vecchia installazione, non preoccuparti, puoi riutilizzarle e salvare i dati gi&agrave; esistenti!</small>',
	...
	'Installation_JsTagHelp' => '<p>Per conteggiare tutti i visitatori, devi inserire il codice JavaScript in tutte le pagine del sito.</p><p>Non &egrave; necessario che siano scritte in PHP, Intranet Statistics supporta tutti i tipi di pagine (HTML, ASP, Perl o un qualunque altro linguaggio).</p><p>Questo &egrave; il codice da inserire: (copia e incolla in tutte le tue pagine) </p>',
	'Installation_Congratulations' => 'Congratulazioni',
	'Installation_CongratulationsHelp' => '<p>Congratulazioni! L\'installazione di Intranet Statistics &egrave; stata completata.</p><p>Assicurati che il codice JavaScript sia inserito in tutte le pagine del sito e aspetta i tuoi primi visitatori!</p>',
	...
	'Installation_SecurityNewsletter' => 'Informami via e-mail sugli aggiornamenti pi&ugrave; importanti di Intranet Statistics',
	...
	'Installation_SystemCheckWarning' => 'Intranet Statistics non sar&agrave; pienamente funzionante, ma alcune funzioni potrebbero essere mancanti.',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics &egrave; un software open source che ti permette di analizzare facilmente le informazioni dei visitatori che visitano i tuoi siti web.</p><p>Questa procedura si divide in %s semplici passaggi e si completa nel giro di 5 minuti.</p>',
	'Installation_ErrorInvalidState' => 'Errore: sembra che stai tentando di saltare un passaggio del processo di installazione, i tuoi Cookies sono disabilitati o il file di configurazione Intranet Statistics &egrave; stato gi&agrave; creato. %1$sControlla che i Cookies siano attivati%2$s e %3$s ripeti l\'installazione dal primo passaggio %4$s.',
	'Installation_PluginDescription' => 'Processo di installazione di Intranet Statistics. L\'installazione &egrave; di solito fatta una sola volta. Se il file di configurazione (config/config.inc.php) viene cancellato, l\'installazione partir&agrave; di nuovo.',
...
<b>Intranet Statistics funzioner&agrave; correttamente</b>. Tuttavia per coerenza, &egrave; raccomandabile che tu faccia una delle seguenti cose: 
<ul style="list-style: disc;margin-left:10px"><li>nel tuo config/config.ini.php, aggiungi <code>charset = utf8</code> sotto la sezione [database] del tuo file di configurazione Intranet Statistics <code>config/config.ini.php</code></li><li>ricompila libmysql --with-charset=utf8</li></ul>',
	...
	'Installation_JsTagArchivingHelp' => 'Per siti a traffico medio/alto, dai un occhio a <a target="_blank" href="http://piwik.org/docs/setup-auto-archiving/">How to setup auto archiving page</a> per far andare Intranet Statistics molto veloce!',
	...
	'Installation_SystemCheckParseIniFileHelp' => 'Questa funzione &egrave; stata disabilitata sul tuo host. Intranet Statistics prover&agrave; a simularla ma potrebbe incontrare altre restrizioni di sicurezza. Anche le prestazioni del tracciatore potrebbero risentirne.',
	...
	'LanguagesManager_PluginDescription' => 'Questo plugin mostrer&agrave; la lista delle lingue disponibili per l\'interfaccia Intranet Statistics. La lingua selezionata sar&agrave; salvata nelle preferenze per ciascun utente.',
...
Attualmente mantenuto come un plugin Intranet Statistics del core.',
	...
	'SitesManager_JsTrackingTagHelp' => 'Qui &egrave; visualizzato il codice JavaScript da includere in tutte le pagine che vuoi vengano controllate da Intranet Statistics',
	...
	'SitesManager_AliasUrlHelp' => 'E\' raccomandato, ma non necessario, di specificare le diverse URL che i tuoi utenti usano per accedere al sito. Gli URL alias di un sito non compariranno tra i siti Referer. Nota che non &egrave; necessario specificare le URL con e senza \'www\' perch&egrave; Intranet Statistics lo considerer&agrava; entrambi automaticamente.',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Gli utenti anonimi non possono essere modificati o cancellati. Questo profilo &egrave; utilizzato da Intranet Statistics per definire un utente che non ha effettuato l\'accesso. Per esempio, se vuoi rendere pubbiche le tue statistiche, puoi dare il privilegio "Visualizza" al profilo degli utenti anonimi.',
	'UsersManager_ExceptionSuperUser' => 'L\'utente richesto &egrave; un Super User e non pu&oacute; essere richiamato, modificato o cancellato via API. Puoi modificare i dettagli dell\'utente nel file di configurazione di Intranet Statistics.',
