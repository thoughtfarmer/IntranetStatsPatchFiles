...
$translations = array(
	...
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s is available. %2$s Please update now!%3$s (see %4$s changes%5$s).',
	...
	'CoreHome_NoPrivileges' => 'You are logged in as \'%s\' but it seems you don\'t have any permission set in Intranet Statistics.<br />Ask your Intranet Statistics administrator to give you \'view\' access to a website.',
	...
	'CoreUpdater_NoteForLargePiwikInstances' => 'Important note for large Intranet Statistics installations',
	...
	'DBStats_MainDescription' => 'Intranet Statistics is storing all your web analytics data in the MySQL database. Currently, Intranet Statistics tables are using %s.',
	'DBStats_LearnMore' => 'To learn more about how Intranet Statistics processes data and how to make Intranet Statistics work well for medium and high traffic websites, check out the documentation %s.',
	'DBStats_Table' => 'Table',
	...
	'Installation_LargePiwikInstances' => 'Help for large Intranet Statistics instances',
	'Installation_JsTag' => 'JavaScript Tag',
	'Installation_JsTagArchivingHelp' => 'For medium and high traffic websites, check out the  <a target="_blank" href="http://piwik.org/docs/setup-auto-archiving/">How to setup auto archiving page</a> to make Intranet Statistics run really fast!',
...
Note that it is not necessary to specify the URLs with and without \'www\' as Intranet Statistics automatically considers both.',
