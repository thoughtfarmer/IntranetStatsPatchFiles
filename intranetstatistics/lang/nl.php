...
$translations = array(
	...
	'General_PiwikIsACollaborativeProject' => '%s Intranet Statistics %s is een project in samenwerkings verband en bevindt zich in de beta fase. Neem %scontact%s met ons op wanneer u wilt helpen!',
	...
	'General_PiwikIsACollaborativeProjectYouCanContribute' => '<a target=\'new\' href=\'http://www.intranetstatistics.com\'>Intranet Statistics</a> is based on %1$s Piwik %2$s. %3$sPiwik is a collaborative project. Check out %4$s How to participate in Piwik?%5$s',
	...
	'General_ExceptionDatabaseVersion' => 'Je %1$s versie is %2$s maar Intranet Statistics vereist ten minste %3$s.',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Sta toe Intranet Statistics archivatie te starten wanneer rapporten worden bekeken vanuit de browser.',
	'General_ArchivingInlineHelp' => 'Voor middelgrote tot grote websites, is  het aan te raden Intranet Statistics archivatie voor de browser uit te schakelen. Als alternatief raden we je aan een cron job te maken om piwik om het uur rapporten te laten genereren.',
	'General_ArchivingTriggerDescription' => 'Aangeraden voor grote Intranet Statistics installaties, gebruik een %scron job%s om automatisch rapporten te genereren.',
	...
	'General_YouAreViewingDemoShortMessage' => 'Je bekijkt momenteel de demo versie van Intranet Statistics.',
	...
	'General_NewReportsWillBeProcessedByCron' => 'Wanneer Intranet Statistics archivering niet worden ingeschakeld door de browser, zullen nieuwe rapporten verwerkt worden door de crontab.',
	...
	'General_PleaseUpdatePiwik' => 'Gelieve je Intranet Statistics up te daten',
	...
	'API_PluginDescription' => 'Alle data in Intranet Statistics is beschikbaar via simpele Apis. Deze plugin is de web service beginpunt, dat je kunt aanroepen om je Web Analytics data te ontvangen in xml, json, php, csv, enz.',
	...
	'CoreAdminHome_PluginDescription' => 'Administratie gedeelte van Intranet Statistics',
	'CoreHome_NoPrivileges' => 'U bent ingelogd als \'%s\' maar het lijkt er op dat u niet voldoende rechten bezit Intranet Statistics te gebruiken.<br />Vraag uw Intranet Statistics administrator om \'kijkers rechten\' voor een website.',
	...
	'CoreUpdater_UpdateTitle' => 'Intranet Statistics &rsaquo; Update',
	...
	'CoreUpdater_PiwikWillBeUpgradedToVersionX' => 'Intranet Statistics zal ge-upgrade worden naar versie %s. ',
	...
	'CoreUpdater_HelpMessageContent' => 'Controleer de %1$s Intranet Statistics FAQ %2$s waarin de meest voorkomende upgrade foutmeldingen worden uitgelegd. %3$s Vraag uw systeem beheerder - deze kan u wellicht helpen met deze fout die waarschijnlijk gerelateerd is aan de configuratie van uw web- of mysql server.',
	...
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Intranet Statistics Database zal geüpgraded worden van versie %1$s naar de nieuwe versie %2$s ',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Belangrijke mededeling voor grote Intranet Statistics installaties',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Als je een grote Intranet Statistics database hebt, kunnen de updates te lang duren om in de browser te worden uitgevoerd. In dat geval, kun je de updates uitvoeren vanaf de opdrachtprompt: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Als je de opdrachtprompt updater niet kan gebruiken en piwik kan niet upgraden (vanwege een timeout van de database, een browser timeout of een ander probleem), dan kun je de SQL queries manueel uitvoeren om Intranet Statistics te updaten.',
	...
	'CoreUpdater_ErrorDIYHelp_3' => 'Update manueel de \'option\' tabel in uw Intranet Statistics database, en zet de waarde version_core naar de versie van de mislukte update',
	...
	'DBStats_MainDescription' => 'Intranet Statistics slaat alle analyse data op in een MySQL database. Momenteel is de omvang van deze database %s.',
	'DBStats_Table' => 'Tabel',
	...
	'DBStats_LearnMore' => 'Om meer te weten over hoe Intranet Statistics data verwerkt en hoe Intranet Statistics goed te laten werken voor middelgrote en grote website\'s, zie de documentatie %s.',
	...
	'ExamplePlugin_blogPiwikRss' => 'Blog Intranet Statistics RSS',
	...
	'ExampleUI_PluginDescription' => 'Voorbeeld plugin: Deze plugin toont hoe tewerken met de Intranet Statistics UI: tabellen aanmaken, grafieken, enz...',
	...
	'Feedback_SpecialRequest' => 'Heeft u een speciaal verzoek voor het Intranet Statistics team?',
	'Feedback_ContactThePiwikTeam' => 'Contacteer het Intranet Statistics team!',
	...
	'Feedback_CategoryHire' => 'Neem een Intranet Statistics consultant in dienst',
	...
	'Feedback_ThankYou' => 'Bedankt om ons te helpen Intranet Statistics beter te maken!',
	...
	'Goals_NoGoalsNeedAccess' => 'Alleen een beheerder of Super gebruiker kan doelstellingen toevoegen voor een website. Gelieve je Intranet Statistics beheerder te vragen een doelstelling op te zetten voor je website. <br> Doelstellingen bijhouden is een goede manier om je website prestaties te begrijpen en maximaliseren!',
	...
	'Goals_DefaultRevenueHelp' => 'Bijvoorbeeld, een Contact formulier dat is verzonden door een bezoeker kan gemiddeld 10$ waard zijn. Intranet Statistics zal je helpen begrijpen hoe goed je bezoekers gedeelten presteren.',
	...
	'Installation_NoConfigFound' => 'Het Intranet Statistics configuratie bestand werd niet gevonden.<br /><b>&nbsp;&nbsp;&raquo; U kunt <a href=\'index.php\'>Intranet Statistics nu installeren</a></b><br /><small>Wanneer u Intranet Statistics al eerder ge&iuml;nstalleerd heeft, en er zit reeds data in de Intranet Statistics tabellen: maakt u zich geen zorgen, u kunt uw bestaande data blijven gebruiken!</small>\',',
	...
	'Installation_ContratulationsHelp' => '<p>Gefeliciteerd! Uw Intranet Statistics installatie is compleet.</p><p>Voeg het javascript toe aan uw pagina\'s, en wacht op uw eerste bezoekers!</p>',
	'Installation_GoToPiwik' => 'Naar Intranet Statistics',
	...
	'Installation_TablesWarning' => 'Sommige <span id="linkToggle">Intranet Statistics tabellen</span> bestaan reeds in de database',
	...
	'Installation_CongratulationsHelp' => '<p>Gefeliciteerd! Uw Intranet Statistics installatie is voltooid.</p><p>Controleer of de javascript code geplaatst is op uw paginas, en wacht op de eerste bezoekers!</p>',
	'Installation_DatabaseCreatedSuccess' => 'Database %s successvol aangemaakt',
	'Installation_PluginDescription' => 'Installatie proces van Intranet Statistics. De installatie wordt meestal maar éénmaal uitgevoerd. Als het configuratie bestand config/config.inc.php is verwijderd, zal de installatie opnieuw beginnen.',
	...
	'Installation_ConnectionCharacterSetNotUtf8' => 'cliënt connectie naar de database server is standaard niet UTF8. Dit is not een kritiek probleem:<b>Intranet Statistics zal correct werken</b>. Maar voor de consistentie is het aanbevolen dat u één van de volgende stappen onderneemt: <ul style="list-style: disc;margin-left:10px"><li>in uw piwik config/config.ini.php, voeg <code>charset = utf8</code> onder de [database] sectie of uw Intranet Statistics configuratie bestand <code>config/config.ini.php</code> toe</li><li>hercompileer libmysql --with-charset=utf8</li></ul> ',
	...
	'Installation_LargePiwikInstances' => 'Hulp voor grote Intranet Statistics instanties ',
	'Installation_JsTagArchivingHelp' => 'Voor middelgrote en grote websites, lees  <a target="_blank" href="http://piwik.org/docs/setup-auto-archiving/">How to setup auto archiving page</a> om Intranet Statistics echt snel te maken!',
	...
	'Installation_SecurityNewsletter' => 'stuur mij e-mails over grote Intranet Statistics upgrades en beveiliging waarschuwingen ',
	...
	'Installation_SystemCheckDatabaseHelp' => 'Intranet Statistics vereist ofwel de mysqli extensie of de PDO en pdo_mysql extensie',
	...
	'Installation_ConfigurationHelp' => 'Uw Intranet Statistics configuratie bestand is waarschijnlijk slecht geconfigureerd. U kunt ofwel config/config.ini.php verwijderen en verder gaan met de installatie, of de database connectie instellingen corrigeren.',
	'Installation_ErrorInvalidState' => 'Fout: Het lijkt erop dat u probeerde een stap van het installatieproces over te slaan, of dat cookies uitgeschakeld zijn, of dat uw Intranet Statistics configuratie bestand al reeds was aangemaakt. %1$s Zorg ervoor dat uw cookies zijn ingeschakeld%2$s en ga terug %3$s naar de eerste pagina van de installatie %4$s.',
	...
	'Login_ContactAdmin' => 'Mogelijke reden: uw host heeft mogelijk de mail() functie geblokkeerd. <br />Neem contact op met uw Intranet Statistics administrator.',
	...
	'SitesManager_PluginDescription' => 'Website beheer in Intranet Statistics: Voeg een nieuwe website toe, pas een bestaande aan, toon de javascript code om te embedden in uw pagina\'s. Alle acties zijn ook beschikbaar via de API',
	...
	'TranslationsAdmin_PluginDescription' => 'Help Intranet Statistics te vertalen in jouw taal.',
	...
	'UsersManager_MainDescription' => 'Stel in welke gebruikers toegang hebben tot de Intranet Statistics rapporten van deze website. U kan de toegangs rechten voor alle websites tegelijk bepalen door deze optie te kiezen in de dropdown',
	...
	'UsersManager_ExceptionEditAnonymous' => 'De anonieme gebruiker kan niet gewijzigd of verwijderd worden. Deze wordt door Intranet Statistics gebruikt om te bepalen of een gebruiker al dan niet is ingelogd. U kunt bijvoorbeeld uw statistieken publiekelijk maken door de anonieme gebruiker \'kijkers rechten\' te geven.',
	...
	'UsersManager_ExceptionSuperUser' => 'Vereiste gebruikers is de Super Gebruiker en kan niet worden opgevraagd, bewerkt of verwijderd via de API. U kunt de Super Gebruiker aanpassen in uw Intranet Statistics configuratie bestand.',
	...
	'Widgetize_PluginDescription' => 'Deze plugin maakt het zeer gemakkelijk om elke Intranet Statistics widget te exporteren in uw blog, website, of op iGoogle en Netvibes.',
	'General_PleaseSpecifyValue' => 'Gelieve een waarde op te geven voor \'%s\'.',
	'API_QuickDocumentationTitle' => 'API korte handleiding',
	'API_GenerateVisits' => 'Als je geen data hebt voor vandaag, kun je eerst wat data genereren met de %s plugin. Je kunt de %s plugin inschakelen, en dan klikken op het Bezoekers generator menu in het Intranet Statistics beheer gedeelte.',
	...
	'CoreHome_JavascriptDisabled' => 'JavaScript moet ingeschakeld zijn om Intranet Statistics in standaard weergave te bekijken. <br/> Het lijkt erop dat JavaScript is uitgeschakeld of niet ondersteund wordt door je browser.<br/> Om de standaard weergave te gebruiken, schakel JavaScript in door je browser instellingen te wijzigen, probeer het daarna %1$s opnieuw %2$s.<br/>',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics kan de huidige installatie niet overschrijven. Je kunt de huidige map/bestands rechten wijzigen, of de nieuwe versie downloaden en versie %s manueel installeren: ',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Intranet Statistics één klik update is geannuleerd. Als je het bovenstaande fout bericht niet kan oplossen, raden we je aan Intranet Statistics manueel te updaten. %1$s Lees de %2$s Update documentatie %3$s om te beginnen.  ',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => 'Leer meer over %s Doelen bijhouden in Intranet Statistics%s in de gebruikershandleiding.',
	'Installation_PleaseFixTheFollowingErrors' => 'Gelieve volgende problemen oplossen',
	'Installation_Timezone' => 'tijd zone website',
	'Installation_SystemCheckGlobHelp' => 'Deze ingebouwde functie is uitgeschakeld door je host. Intranet Statistics zal proberen deze functie te emuleren, maar kan andere veiligheids restricties oplopen. Functionaliteit kan worden ingeperkt.',
	...
	'SitesManager_PiwikWillAutomaticallyExcludeCommonSessionParameters' => 'Intranet Statistics sluit veelvoorkomende sessie parameters uit (%s).',
	'SitesManager_HelpExcludedIps' => 'Voer de IP adressen in (één per lijn) dat je niet wil volgen via Intranet Statistics. Je kunt wildcards gebruiken, bijv. %1$s of %2$s',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%s Jouw Intranet Statistics bezoeken worden genegeerd door Intranet Statistics op %s %s (Intranet Statistics negeer cookie is gevonden in je browser).',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Klik hier om de cookie te verwijderen en laat Intranet Statistics je bezoeken volgen.',
	'UsersManager_ClickHereToSetTheCookieOnDomain' => 'Klik hier om een cookie te plaatsen dat jouw bezoeken uitsluit van Intranet Statistics op %s',
