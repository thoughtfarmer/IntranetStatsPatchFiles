...
$translations = array(
	...
	'General_BackToHomepage' => 'Powrót do strony głównej Intranet Statistics',
	'General_Yes' => 'Tak',
	'General_No' => 'Nie',
	'General_Delete' => 'Usuń',
	'General_Edit' => 'Edycja',
	...
	'General_RequiresFlash' => 'Wyświetlanie grafik przez Intranet Statisticsa wymaga Flasha',
	'General_GraphHelp' => 'Więcej informacji na temat wyświetlania grafik przez Intranet Statisticsa.',
	...
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s jest dostępny. %2$s Zaktualizuj go teraz!%3$s (zobacz %4$s zmiany%5$s).',
	'General_BackToPiwik' => 'Wróć do Intranet Statisticsa',
	...
	'General_ExceptionDatabaseVersion' => 'Twoja %1$s wersja to %2$s Intranet Statistics wymaga przynajmniej %3$s.',
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Pozwól Intranet Statistics na uruchomienie archiwizacji kiedy raporty są oglądane za pomocą przeglądarki',
	'General_ArchivingInlineHelp' => 'Dla średnich i dużych witryn, zalecane jest wyłączenie uruchamiania archiwizacji Intranet Statistics z poziomu przeglądarki. Zamiast tego zaleca się ustawienie zadania w cron do przetwarzania raportów co godzinę.',
	'General_ArchivingTriggerDescription' => 'Zalecane w przypadku większych instalacji Intranet Statistics, musisz %sustawić zadanie w cron%s do przetwarzania raportów automatycznie.',
	...
	'General_YouAreViewingDemoShortMessage' => 'Aktualnie oglądasz demo Intranet Statistics',
	'General_DownloadFullVersion' => '%1$sŚciągnij%2$s pełną wersje! Sprawdź %3$s',
	'General_NewUpdatePiwikX' => 'Nowa aktualizacja: Intranet Statistics %s',
	...
	'General_ConfigFileIsNotWritable' => 'Plik konfiguracyjny Intranet Statistics %s jest niezapisywalny, Twoje zmiany nie zostaną zachowane. %s Zmień uprawnienia pliku konfiguracyjnego, robiąc go zapisywalnym.',
	...
	'General_PleaseUpdatePiwik' => 'Zaktualizuj swój Intranet Statistics',
	'General_PleaseSpecifyValue' => 'Określ wartość dla \'%s\'',
	'API_PluginDescription' => 'Wszystkie dane z Intranet Statistics są dostępne przez proste API. Ten plugin jest punktem usług internetowych który możesz wywołać do pobrania Twoich statystyk w postaci xml, json, php, csv, etc.',
	'API_QuickDocumentation' => '<h2>API quick documentation</h2><p>If you don\'t have data for today you can first <a href=\'misc/generateVisits.php\' target=_blank>generate some data</a> using the Visits Generator script.</p><p>You can try the different formats available for every method. It is very easy to extract any data you want from Intranet Statistics!</p><p><b>For more information have a look at the <a href=\'http://dev.piwik.org/trac/wiki/API\'>official API Documentation</a> or the <a href=\'http://dev.piwik.org/trac/wiki/API/Reference\'>API Reference</a>.</b></P><h2>User authentication</h2><p>If you want to <b>request the data in your scripts, in a crontab, etc. </b> you need to add the parameter <code><u>&amp;token_auth=%s</u></code> to the API calls URLs that require authentication.</p><p>This token_auth is as secret as your login and password, <b>do not share it!</p>',
	...
	'API_GenerateVisits' => 'Jeśli nie masz dziś żadnych statystyk, możesz najpierw wygenerować pewne dane używając pluginu %s. Włącz plugin %s, następnie kliknij na "Generator odwiedzających" w menu na obszarze administracyjnym Intranet Statistics.',
	'API_MoreInformation' => 'Więcej informacji o API Intranet Statistics znajdziesz we %s Wprowadzeniu do API Intranet Statistics %s i w %s Intranet Statistics API Reference %s.',
	...
	'CoreAdminHome_PluginDescription' => 'Obszar administracyjny Intranet Statistics.',
	'CoreAdminHome_MenuGeneralSettings' => 'Ustawienia ogólne',
	'CoreAdminHome_Administration' => 'Administracja',
	'CoreHome_NoPrivileges' => 'Jesteś zalogowany jako \'%s\' ale wygląda na to, że nie masz ustawionych żadnych uprawnień w Intranet Statistics.<br/>Poproś swojego Intranet Statistics administratora, żeby dał Ci dostęp do przeglądania strony.',
	...
	'CorePluginsAdmin_MainDescription' => 'Pluginy poszerzają i powiększają funkcjonalność Intranet Statistics. Po zainstalowaniu wtyczki, można ją włączyć lub wyłączyć tutaj.',
	...
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Baza danych Intranet Statistics jest nieaktualna i musi być uaktualniona przed kontynuowaniem.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Baza danych Intranet Statistics zostanie uaktualniona z wersji %1$s do nowej wersji %2$s.',
	'CoreUpdater_TheFollowingPluginsWillBeUpgradedX' => 'Następujące wtyczki zostaną uaktualnione: %s.',
	'CoreUpdater_NoteForLargePiwikInstances' => 'Ważna uwaga dla dużych instalacji Intranet Statistics',
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Jeśli masz dużą baze danych Intranet Statistics, aktualizacja może trwać zbyt długo do uruchomienia w przeglądarce. W tej sytuacji, możesz uruchomić aktualizacje z Twojej linii poleceń: %s',
	'CoreUpdater_YouCouldManuallyExecuteSqlQueries' => 'Jeśli nie możesz użyć aktualizatora linii poleceń i jeśli Intranet Statistics się nie uaktualnił (z powodu przekroczenia limitu czasu w bazie danych, limitu czasu w przeglądarce, lub jakiegokolwiek innego powodu), możesz uruchomić ręcznie zapytania SQL w celu zaktualizowania Intranet Statistics.',
	...
	'CoreUpdater_UpgradePiwik' => 'Aktualizuj Intranet Statistics',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics został zaktualizowany pomyślnie!',
	'CoreUpdater_ContinueToPiwik' => 'Kontynuuj',
	'CoreUpdater_UpdateAutomatically' => 'Zaktualizuj automatycznie',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Dostępna jest nowa wersja Intranet Statistics do aktualizacji',
	...
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Intranet Statistics One Click Update został anulowany. Jeśli nie można naprawić powyższy komunikat o błędzie, zaleca się, aby ręcznie zaktualizować Intranet Statistics. %1$s Prosze zapoznać się z %2$sDokumentacją aktualizacji%3$s żeby rozpocząć!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics zaktualizowany pomyślnie!',
	'CoreUpdater_EmptyDatabaseError' => 'Baza danych %s jest pusta. Musisz edytować lub usunąć plik konfiguracyjny Intranet Statistics.',
	'CoreUpdater_ExceptionAlreadyLatestVersion' => 'Twoja wersja Intranet Statistics %s jest aktualna.',
	...
	'CoreUpdater_YouMustDownloadPackageOrFixPermissions' => 'Intranet Statistics nie jest w stanie zastąpić bieżącej instalacji. Musisz albo ustalić uprawnienia do katalogu/pliku albo ściągnąć pakiet i zainstalować wersje %s ręcznie:',
	'DBStats_PluginDescription' => 'Plugin raportuje użycie bazy danych MySQL przez tabele Intranet Statistics.',
	...
	'ExampleUI_PluginDescription' => 'Przykładowy plugin: Ten plugin pokazuje jak pracować z Intranet Statistics UI: tworzyć tabele, wykresy, itp.',
	'Feedback_PluginDescription' => 'Wyślij swoją opinie do zespołu Intranet Statistics. Podziel się z nami swoimi pomysłami i sugestiami.',
	...
	'Feedback_WhyWrongCountry' => 'Dlaczego Intranet Statistics pokazuje mojej wizyty z niewłaściwego kraju?',
	'Feedback_VisitTheForums' => 'Odwiedź %s Forum%s',
	'Feedback_SpecialRequest' => 'Masz specjalne życzenie dla zespołu Intranet Statistics',
	'Feedback_ContactThePiwikTeam' => 'Skontaktuj się z zespołem Intranet Statistics!',
	'Feedback_IWantTo' => 'Chcę:',
	'Feedback_CategoryShareStory' => 'Podziel się historią sukcesu Intranet Statistics',
	'Feedback_CategorySponsor' => 'Sponsoruj Intranet Statistics',
	'Feedback_CategoryHire' => 'Zatrudnij konsultanta Intranet Statistics',
	...
	'Feedback_MessageSent' => 'Twoja wiadomość została wysłana do zespołu Intranet Statistics.',
	'Feedback_ThankYou' => 'Dziękujemy Ci za pomoc w ulepszaniu Intranet Statistics!',
	'Feedback_ThePiwikTeam' => 'Zespół Intranet Statistics',
	...
	'Goals_NoGoalsNeedAccess' => 'Tylko Administratorzy lub Super Użytkownicy mogą dodać cel do wybranej strony. Poproś administratora Intranet Statistics żeby utworzyć cel witryny. <br> Śledzenie celów to świetny sposób, aby pomóc zrozumieć i zwiększyć wydajność swojej strony!',
	...
	'Installation_ConnectionCharacterSetNotUtf8' => 'Client connection to the database server is not set to UTF8 by default. This is not critical issue: <b>Intranet Statistics should work correctly</b>. However for consistency, it is recommended that you do one of the following: <ul style="list-style: disc;margin-left:10px"><li>in your piwik config/config.ini.php, add <code>charset = utf8</code> under the [database] section of your Intranet Statistics configuration file <code>config/config.ini.php</code></li><li>recompile libmysql --with-charset=utf8</li></ul>',
	...
	'Installation_JsTagHelp' => '<p>To count all visitors, you must insert the JavaScript code on all of your pages.</p><p>Your pages do not have to be made with PHP, Intranet Statistics will work on all kinds of pages (whether it is HTML, ASP, Perl or any other languages).</p><p>Here is the code you have to insert: (copy and paste on all your pages) </p>',
	'Installation_JsTagHelpTitle' => 'How to insert the tag in your websites?',
	'Installation_LargePiwikInstances' => 'Pomoc dla dużych instancji Intranet Statistics',
	'Installation_JsTagArchivingHelp' => 'Dla średnich i dużych witryn, sprawdź <a target="_blank" href="http://piwik.org/docs/setup-auto-archiving/">Jak skonfigurować automatyczną archiwizacje strony</a> by sprawić, żeby Intranet Statistics działał naprawdę szybko!',
	'Installation_Congratulations' => 'Gratulacje',
	'Installation_CongratulationsHelp' => '<p>Gratulacje! Twój Intranet Statistics został zainstalowany pomyślnie.</p><p>Upewnij się, że kod JavaScript jest wprowadzony do Twoich stron i czekaj na pierwszych odwiedzających!</p>',
	...
	'Installation_Requirements' => 'Wymagania Intranet Statistics',
	...
	'Installation_TablesWithSameNamesFound' => 'Niektóre %1$s tabele w Twojej bazie danych %2$s mają takie same nazwy jak te które próbuje utworzyć Intranet Statistics',
	...
	'Installation_TablesDeletedSuccess' => 'Istniejące tabele Intranet Statistics usunięte pomyślnie',
	...
	'LanguagesManager_PluginDescription' => 'Ten plugin wyświetla listę dostępnych języków dla interfejsu Intranet Statistics. Wybrany język będzie zapisany w preferencjach każdego użytkownika.',
...
Note: this token will expire in 24 hrs.',
	...
	'SitesManager_PluginDescription' => 'Zarządzanie stronami internetowymi w Intranet Statistics: dodawanie nowej strony, edytowanie istniejących stron, kod JavaScript do wklejenia na Twoją stronę. Wszystkie działania są dostępne również przez API.',
	...
	'SitesManager_HelpExcludedIps' => 'Wpisz liste IP, po jednym w wierszu, które chcesz wykluczyć ze śledzenia przez Intranet Statistics.
...
Możesz użyć wildcards, np. %1$s lub %2$s',
	...
	'TranslationsAdmin_PluginDescription' => 'Pomóż w tłumaczeniu Intranet Statistics na Twój język',
	...
	'UsersManager_PluginDescription' => 'Zarządzanie użytkownikami w Intranet Statistics: dodawanie nowego użytkownika, edytowanie już istniejącego, aktualizowanie uprawnień. Wszystkie te akcje są dostępne również przez API.',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Użytkownik anonimowy nie może być zmieniony lub skasowany. Używany jest przez Intranet Statistics to do definicji użytkownika nie zalogowanego. Dla przykładu możesz ustawić swoje statystyki do wglądu dla wszystkich poprzez przyznanie prawa wglądu użytkownikowi anonimowemu \'anonymous\'.',
	...
	'UsersManager_YourVisitsAreIgnoredOnDomain' => '%sTwoje wizyty są ignorowane przez Intranet Statistics na %s %s (wykryto w przeglądarce cookie wykluczające Twoje wizyty).',
	'UsersManager_YourVisitsAreNotIgnored' => '%sTwoje wizyty nie są ignorowane przez Intranet Statistics%s (nie wykryto w przeglądarce cookie wykluczające Twoje wizyty).',
	'UsersManager_ClickHereToDeleteTheCookie' => 'Kliknij w celu usunięcia cookie żeby Intranet Statistics mógł zliczać Twoje wizyty',
	'UsersManager_ClickHereToSetTheCookieOnDomain' => 'Kliknij tu żeby ustawić cookie wykluczające Twoje wizyty na stronach śledzonych przez Intranet Statistics na %s',
	...
	'UsersManager_WhenUsersAreNotLoggedInAndVisitPiwikTheyShouldAccess' => 'Kiedy użytkownicy nie są zalogowani i odwiedzają Intranet Statistics, wyświetli im się',
	...
	'Widgetize_PluginDescription' => 'Ten plugin sprawia że łatwo wyeksportować jakikolwiek widżet Intranet Statistics do Twojego bloga, strony internetowej lub Igoogle i Netvibes',
);