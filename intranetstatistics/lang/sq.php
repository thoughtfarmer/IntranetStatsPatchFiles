...
$translations = array(
	...
	'CoreHome_NoPrivileges' => 'Jeni futur si \'%s\', por duket se nuk keni leje të rregulluara për te Intranet Statistics-u.<br />Kërkojini përgjegjësit tuaj për Intranet Statistics-un t\'ju japë të drejta \'parjeje\' për te "site"-i web.',
	...
	'CoreUpdater_UpdateTitle' => 'Intranet Statistics &rsaquo; Përditësim',
	...
	'CoreUpdater_TheUpgradeProcessMayFail' => 'Po qe se keni një bazë të dhënash Intranet Statistics të madhe, përditësimet mund të duan shumë për të xhiruar në shfletues. Në një rast të tillë, përditësime mund t\'i kryeni përmes rreshti urdhrash: <code>$ php shtegu/për_te/piwik/index.php</code>',
	...
	'ExamplePlugin_blogPiwikRss' => 'RSS Blogu Intranet Statistics',
	...
	'Installation_JsTagHelp' => '<p>Për numërimin e tërë vizitorëve, duhet të fusni kodin JavaScript në tërë faqet tuaj.</p><p>Nuk është e thënë që faqet tuaja duhet të jenë krijuar me PHP, Intranet Statistics-u do të funksionojë me tërë llojet e faqeve (HTML apo ASP, Perl ose cilëndo gjuhë tjetër).</p><p>Ja kodi që duhet të fusni: (kopjojeni dhe ngjiteni në tërë faqet tuaja) </p>',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics-u është një program analize web, me burim të hapur, që e bën të lehtë të kihen të dhëna që dëshironi rreth vizitorëve tuaj.</p><p>Ky proces është ndarë në %s hapa të kollajtë dhe do të zgjasë rreth 5 minuta.</p>',
	...
	'Installation_JsTagArchivingHelp' => 'Për "site"-e web me trafik mesatar ose të madh, shihni <a target="_blank" href="http://piwik.org/docs/setup-auto-archiving/">Si të rregullohet vetëarkivimi i faqeve</a>, për ta bërë Intranet Statistics-un të xhirojë vërtet shpejt!',
