...
$translations = array(
	...
	'CoreHome_NoPrivileges' => 'Está identificado como \'%s\', pero semella que non ten os permisos en Intranet Statistics.<br />Contacte co administrador do seu sistema Intranet Statistics para que lle dea acceso para entrar á páxina.',
	...
	'Installation_JsTagHelp' => '<p>Para contar todos os visitantes, debe inserir o código Javascript en todas as páxinas.</p><p>As súas páxinas non teñen por que estar feitas en PHP, Intranet Statistics funcionará en todas as páxinas (tanto se son HTML, ASP, Perl ou calquera outra linguaxe).</p><p>Aquí está o código a inserir: (cópiao e pégao en todas as túas páxinas) </p>',
	...
	'Installation_GoToPiwik' => 'Ir a Intranet Statistics',
	...
	'Installation_TablesWarning' => 'Algunhas <span id="linkToggle">táboas de Intranet Statistics</span> están xa instaladas na base de datos',
	...
	'Installation_TablesDeleteConfirm' => 'Está seguro de querer eliminar todas as táboas de Intranet Statistics desta base de datos?',
