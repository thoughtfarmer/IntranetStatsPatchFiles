...
$translations = array(
	...
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s finns tillg&auml;ngligt. %2$s Var v&auml;nlig uppdatera! %3$s (se %4$s &auml;ndringar%5$s).',
	...
	'CorePluginsAdmin_MainDescription' => 'Till&auml;gg ut&ouml;kar Intranet Statistics\'s funktioner. N&auml;r ett till&auml;gg &auml;r installerat kan du aktivera eller avaktivera det h&auml;r.',
	...
	'CoreHome_NoPrivileges' => 'Du &auml;r inloggad som \'%s\' men det ser inte ut som att du har n&aring;gra r&auml;ttigheter inst&auml;llda i Intranet Statistics.<br />Be din Intranet Statistics-admin att ge dig r&auml;ttigheten att visa en webbplats.',
	'CoreHome_JavascriptDisabled' => 'JavaScript m&aring;ste vara till&aring;tet f&ouml;r att kunna anv&auml;nda Intranet Statistics i standardl&auml;ge.<br />Det ser ut som att JavaScript antingen &auml;r avaktiverat eller inte st&ouml;ds av din webbl&auml;sare.<br /> F&ouml;r att anv&auml;nda standardl&auml;get, aktivera JavaScript i din webbl&auml;sare och g&ouml;r ett %1$s1nytt f&ouml;rs&ouml;k%2$s2.<br />',
	...
	'CoreUpdater_UpdateTitle' => 'Intranet Statistics &rsaquo; uppdatering',
	'CoreUpdater_DatabaseUpgradeRequired' => 'Uppgradering av databasen kr&auml;vs',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'Din Intranet Statistics-databas &auml;r utdaterad och m&aring;ste uppgraderas innan du kan forts&auml;tta.',
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Intranet Statistics\'s databas kommer uppgraderas fr&aring;n version %1$s till den nya versionen %2$s.',
	...
	'CoreUpdater_UpgradePiwik' => 'Uppdatera Intranet Statistics',
	'CoreUpdater_HelpMessageContent' => 'Titta i %1$s Intranet Statistics FAQ %2$s som har tagit upp dom vanligaste felen under uppgraderingar. %3$s Fr&aring;ga din systemadministrat&ouml;r  - som kanske kan hj&auml;lpa dig med problemen som troligast &auml;r relaterade till dina server eller MySQL-inst&auml;llningar.',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics uppdaterades utan problem!',
	'CoreUpdater_ContinueToPiwik' => 'Forts&auml;tt till Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => 'Uppdatera automatiskt',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Det finns en ny version av Intranet Statistics tillg&auml;nglig f&ouml;r uppdatering',
	...
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Intranet Statistics "One Click Update" har avbrutits. Om du inte kan &aring;tg&auml;rda felet &auml;r det rekommenderat att du uppgraderar Intranet Statistics manuellt. %1$s Kolla in %2$sUppgraderingsdokumentationen%3$s f&ouml;r att komma ig&aring;ng!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics har uppdaterats!',
	...
	'Login_ContactAdmin' => 'M&ouml;jlig orsak: din v&auml;rd kan ha avaktiverat mail() funktionen. <br />Var v&auml;nlig kontakta din Intranet Statistics-administrat&ouml;r',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Den anonyma anv&auml;ndare kan inte redigeras eller tas bort. Den anv&auml;nds av Intranet Statistics f&ouml;r att definiera en anv&auml;ndare som inte har loggat in &auml;nnu. Till exempel kan du g&ouml;ra din statistik tillg&auml;nglig f&ouml;r allm&auml;nheten genom att ge \'anonymous\' r&auml;ttigheten \'visa\'.',
	'UsersManager_ExceptionSuperUser' => 'Den beg&auml;rda anv&aulm;ndaren &aulm;r huvudanv&auml;ndaren och kan inte f&ouml;rfr&aring;gas, &aulm;ndras eller tas bort via APIn. Du kan &aulm;ndra huvudanv&aulm;ndarens detaljer i konfigurationsfilen f&ouml;r Intranet Statistics.',
	...
	'Installation_NoConfigFound' => 'Du f&ouml;rs&ouml;ker visa en Intranet Statisticssida utan att n&aring;gon konfigurationsfil hittades.<br /><b>&nbsp;&nbsp;&raquo; Du kan <a href=\'index.php\'>installera Intranet Statistics nu</a></b><br /><small>Om du har installerat Intranet Statistics f&ouml;rut och har analyser lagrade i databasen, oroa dig inte, du kan &aring;teranv&auml;nda samma analyser och beh&aring;lla befintlig data!</small>',
	...
	'Installation_JsTagHelp' => '<p>F&ouml;r att r&auml;kna alla bes&ouml;k m&aring;ste du l&auml;gga till Javascript-koden p&aring; alla dina sidor.</p><p>Dina sidor beh&ouml;ver inte vara gjorda med PHP, Intranet Statistics fungerar p&aring; alla typer av sidor (oavsett om det &auml;r HTML, ASP, Perl eller n&aring;got annat spr&aring;k).</p><p>H&auml;r &auml;r koden du m&aring;ste l&auml;gga till: (kopiera och klistra in p&aring; alla dina sidor)</p>',
	'Installation_Congratulations' => 'Grattis',
	'Installation_CongratulationsHelp' => '<p>Grattis! Din installation av Intranet Statistics &auml;r klar.</p><p>Kontrollera att din javascript-kod finns p&aring; alla dina sidor, inv&auml;nta sedan p&aring; dina f&ouml;rsta bes&ouml;kare!',
	'Installation_ContinueToPiwik' => 'Forts&auml;tt till Intranet Statistics',
	...
	'Installation_SecurityNewsletter' => 'notifiera mig om uppdateringar och s&auml;kerhetsbrister i Intranet Statistics via e-post',
	...
	'Installation_SystemCheckWarning' => 'Intranet Statistics kommer fungera men vissa funktioner kan saknas',
	'Installation_Tables' => 'Skapar tabeller',
	'Installation_TablesWithSameNamesFound' => 'N&aring;gra %1$s tabeller i din databas %2$s har samma namn som dom tabeller Intranet Statistics f&ouml;rs&ouml;ker att skapa',
	...
	'Installation_TablesDeletedSuccess' => 'Befintliga Intranet Statistics-tabeller raderades utan problem',
	...
	'Installation_GoBackAndDefinePrefix' => 'G&aring; tillbaka och v&auml;lj ett prefix f&ouml;r Intranet Statisticss tabeller',
	'Installation_Welcome' => 'V&auml;lkommen!',
	'Installation_WelcomeHelp' => '<p>Intranet Statistics &auml;r en open source programvara f&ouml;r webbplatsanalys som g&ouml;r det enkelt att samla in information om dina bes&ouml;kare.</p><p>Den &auml;r processen &auml;r uppdelad i %s enkla steg och kommer ta ca 5 minuter.</p>',
	'Installation_ErrorInvalidState' => 'Fel: det ser ut som att du f&ouml;rs&ouml;kt hoppa &ouml;ver ett steg i installationsprocessen, eller s&aring; har du inte cookies aktiverat, eller s&aring; &auml;r Intranet Statistics\'s konfigurationsfil redan skapad. %1$sKontrollera s&aring; att cookies &auml;r aktiverat%2$s och g&aring; tillbaka %3$s till f&ouml;rsta sidan av installationen %4$s.',
	...
	'DBStats_MainDescription' => 'Intranet Statistics lagrar alla dina analyser i en MySQL-databas. F&ouml;r n&auml;rvarande anv&auml;nder Intranet Statistics %s.',
