...
$translations = array(
	...
	'API_QuickDocumentation' => '<h2>應用程式介面 API 快速文件</h2><p>假如您今天沒有資料，您可以先使用此造訪產生器腳本 <a href=\'misc/generateVisits.php\' target=_blank>產生一些資料</a> ！</p><p>您可以為每種方法嘗試任何不同可用的格式，從 Intranet Statistics 擷取任何資料是非常容易的。</p><p><b>欲取得更多的資訊請查看 <a href=\'http://dev.piwik.org/trac/wiki/API\'>官方 API 文件</a> 或 <a href=\'http://dev.piwik.org/trac/wiki/API/Reference\'>API 參考文件</a>！</b></P><h2>使用者驗證</h2><p>假如您想要 <b>使用一個 crontab 例行排程來以您的腳本請求資料等等... </b> 您必須增加參數 <code><u>&token_auth=%s</u></code> 至需要驗證的 API 呼叫 URL 位址中！</p><p>此 token_auth 使您的登入帳號及密碼更加安全，故 <b>請勿將之洩露給任何人！</p>',
	'API_LoadedAPIs' => '已成功載入 %s 個 APIs',
	'CoreHome_NoPrivileges' => '你已登入為 \'%s\' ，但看起來你在 Intranet Statistics 之中似乎沒有任何權限。<br />請要求你的 Intranet Statistics 管理員提供您\'檢視\'某一個網站的權限。',
	...
	'Login_ContactAdmin' => '可能原因：你的虛擬主機可能已經停用了 mail() 函式。<br />請聯繫你的 Intranet Statistics 管理員。',
	...
	'Installation_NoConfigFound' => '無法找到 Intranet Statistics 設定檔，而你正嘗試存取一個 Intranet Statistics 的頁面。<br /><b>&nbsp;&nbsp;&raquo; 你可以 <a href=\'index.php\'>立刻安裝 Intranet Statistics</a></b><br /><small>假如你之前已安裝過 Intranet Statistics，並且已有些資料表在你的資料庫中，不用擔心，你可以重複使用此相同的資料表並保留現存的資料！</small>',
	'Installation_MysqlSetup' => 'MySQL 資料庫設定',
	'Installation_MysqlErrorConnect' => '當嘗試連線至 MySQL 資料庫時發生錯誤',
	'Installation_JsTag' => 'JavaScript 原始碼',
	'Installation_JsTagHelp' => '<p>要計數所有的訪客，您必須插入 JavaScript 追蹤碼至您所有的網頁之中！</p><p>您的網頁沒必要一定製作成 PHP ，Intranet Statistics 將可工作於所有種類的網頁 (無論是 HTML、ASP、Perl 或任何其他的語言)！</p><p>以下就是您必須插入的追蹤碼：(複製並貼在您所有的網頁中) </p>',
	...
	'Installation_JsTagArchivingHelp' => '在一個中或高流量的網站，請查閱<a target="_blank" href="http://piwik.org/docs/setup-auto-archiving/">如何設定自動彙整頁面</a>來使 Intranet Statistics 運作的更順暢！',
	...
	'ExamplePlugin_blogPiwikRss' => '網誌 Intranet Statistics RSS',
	...
	'Feedback_ContactThePiwikTeam' => '聯繫 Intranet Statistics 小組！',
	...
	'General_Language' => '語系',
	'General_PleaseUpdatePiwik' => '請更新你的 Intranet Statistics',
