...
fersfeir@niux.com.ar',
	...
	'General_BackToHomepage' => 'Volver a la página de inicio Intranet Statistics',
	'General_Yes' => 'Si',
	'General_No' => 'No',
	...
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s está disponible. %2$s  ¡Por favor, actualice ahora!%3$s (ver %4$s cambios%5$s).',
...
Tenga en cuenta que no es necesario especificar las direcciones URL con y sin \'www\' ya que Intranet Statistics considera automáticamente ambas.',
	'SitesManager_Id' => 'Id',
	...
	'Installation_NoConfigFound' => 'El archivo de configuración de Intranet Statistics no se ha encontrado y está intentando acceder a una página de Intranet Statistics.<br /><b>&nbsp;&nbsp;&raquo; Puede <a href=\'index.php\'>instalar Intranet Statistics ahora</a></b><br /><small>¡Si ha instalado Intranet Statistics antes y tiene algunas tablas en su BD, no se preocupe, usted puede reutilizar las mismas tablas y mantener sus datos existentes!</small>',
	...
	'Installation_JsTagHelp' => '<p>Para contar todos los visitantes, debe insertar el código JavaScript en todas sus páginas.</p><p>Sus páginas no tienen que ser hechas con PHP, Intranet Statistics trabajará sobre todo tipo de páginas (si es HTML, ASP, Perl o cualquier otro lenguaje).</p><p>Aquí está el código que debes introducir: (copia y pega en todas tus páginas) </p>',
	...
	'Installation_JsTagArchivingHelp' => 'Para los sitios web de mediano y grande tráfico, eche un vistazo a  <a target="_blank" href="http://piwik.org/docs/setup-auto-archiving/">¡Cómo configurar auto archivado de páginas</a> para hacer que Intranet Statistics funcione más rápido!',
...
En su php.ini, añada las siguientes líneas: %2$s',
	...
	'CoreAdminHome_PluginDescription' => 'Área de Administración para Intranet Statistics',
