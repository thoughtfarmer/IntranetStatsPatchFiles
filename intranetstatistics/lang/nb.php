...
$translations = array(
	...
	'General_PiwikIsACollaborativeProject' => '%s Intranet Statistics %s er et åpent prosjekt og fremdeles i Beta. %s Hvis du vil hjelpe, vennligst %s kontakt oss%s.',
	...
	'CoreHome_NoPrivileges' => 'Du er logget inn som \'%s\' men det ser ikke ut som du har noen tilganger i Intranet Statistics.<br />Spør din Intranet Statistics administrator for å gi deg lesetilgang.',
	...
	'CoreUpdater_PiwikWillBeUpgradedToVersionX' => 'Intranet Statistics vil nå bli oppgradert til versjon %s.',
	...
	'CoreUpdater_TheUpgradeProcessMayFail' => 'Hvis du har en stor Intranet Statistics-database, oppdateringer kan ta for lang tid til bli kjørt i nettleseren. I slike situasjoner kan du kjøre oppdateringene fra kommandolinja: <code>$ php stil/til/piwik/index.php</code>',
...
',
	...
	'Installation_JsTagHelp' => '<p>For å telle alle besøkende, du må plassere JavaScript-koden på alle dine sider.</p><p>Dine sider trenger ikke være laget med PHP, Intranet Statistics vil virke på alle typer sider (uansett om det er HTML, ASP, Perl eller noe annet språk).</p><p>Her er koden du må sette inn: (kopier og lim på alle dine sider)</p>',
...
',
	...
	'Installation_TablesWarning' => 'Noen <span id="linkToggle">Intranet Statistics tabeller</span> er allerede installert i databasen',
...
',
	...
	'Installation_TablesDeleteConfirm' => 'Er du sikker på at du vil slette alle Intranet Statistics-tabellene fra denne databasen?',
...
',
	...
	'UsersManager_YourVisitsAreIgnored' => '%sDine besøk blir ignorert av Intranet Statistics%s (informasjonskapselen for ekskludering fra Intranet Statistics ble funnet i din nettleser).',
	...
	'UsersManager_ClickHereToSetTheCookie' => 'Klikk her for å lage en informasjonskapsel som vil ekskludere dine besøk på nettsteder som spores av Intranet Statistics',
