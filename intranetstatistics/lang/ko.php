...
$translations = array(
	...
	'CorePluginsAdmin_MainDescription' => '플러그인 확장과 Intranet Statistics의 기능성 확장페이지입니다. 플러그인이 한번 설치되면 이곳에서 활성화하거나 비활성화하실 수 있습니다.',
	...
	'CoreUpdater_UpdateTitle' => 'Intranet Statistics &rsaquo; 업데이트',
	...
	'Installation_NoConfigFound' => 'Intranet Statistics 설정 파일을 찾을 수 없으며 당신은 Intranet Statistics 페이지로 접근을 계속 시도하고 있습니다.<br /><b>&nbsp;&nbsp;&raquo; <a href=\'index.php\'>지금 Intranet Statistics을 설치하세요.</a></b><br /><small>만약 Intranet Statistics을 이전에 설치한 적이 있고 DB에 테이블이 좀 있다면 걱정하지마세요, 같은 테이블을 재사용할 수 있고 현재 데이터를 보존할 수 있습니다!</small>',
	...
	'Installation_JsTagHelp' => '<p>모든 방문자를 세려면, 자바스크립트 코드를 모든 페이지에 삽입해야 합니다.</p><p>Y페이지는 PHP로 만들어질 필요는 없으며, Intranet Statistics은 모든 종류의 페이지에서 작동합니다(HTML, ASP, Perl 또는 다른 언어 상관없이).</p><p>삽입해야 될 코드입니다: (복사하고 모든 페이지에 붙여넣기하세요.) </p>',
