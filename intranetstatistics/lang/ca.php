...
$translations = array(
	...
	'General_PiwikIsACollaborativeProject' => '%s El Intranet Statistics %s és un projecte col&middot;laboratiu que encara està en fase Beta. %s Si voleu ajudar, si us plau %s contacteu-nos!%s.',
	...
	'CoreHome_NoPrivileges' => 'Heu iniciat la sessió fent servir l\'usuari \'%s\', però sembla que no teniu cap permís configurat al Intranet Statistics.<br />Demaneu a l\'administrador que us doni permisos de \'vista\' a algun lloc web.',
	...
	'CorePluginsAdmin_MainDescription' => 'Els connectors augmenten la funcionalitat del Intranet Statistics. Un cop hi ha un connector instal&middot;lat, podeu activar-lo i desactivar-lo aquí.',
	...
	'CoreUpdater_PiwikWillBeUpgradedToVersionX' => 'El Intranet Statistics s\'actualitzarà a la versió %s.',
	...
	'CoreUpdater_HelpMessageContent' => 'Comproveu les %1$s PMF del Intranet Statistics (en anglès) %2$s, que intenten explicar els errors més comuns a l\'actualització. %3$s Pregunteu a l\'administrador del sistema, podria ajudar-vos amb l\'error, que sembla estar relacionat amb el servidor o la instal&middot;lació del MySQL.',
...
<code>$ php path/to/piwik/index.php</code>',
	...
	'Installation_NoConfigFound' => 'No s\'ha trobat el fitxer de configuració del Intranet Statistics i esteu intentant accedir una pàgina del Intranet Statistics.<br /><strong>&nbsp;&nbsp;&raquo;Podeu <a href=\'index.php\'>instal&middot;lar el Intranet Statistics ara</a></strong>.<br /><small>Si heu instal·lat el Intranet Statistics abans i teniu algunes taules a la vostra base de dades, no us amoïneu; podeu continuar fent servir les mateixes taules i les dades existents es conservaran!</small>',
	...
	'Installation_JsTagHelp' => '<p>Si voleu comptar tots els visitants, heu d\'inserir el codi JavaScript a totes les pàgines.</p><p>No és necessari que estiguin fetes en PHP, el Intranet Statistics funcionarà a tots els tipus de pàgines (siguin HTML, ASP, Perl o qualsevol altre).</p><p>Aquí teniu el codi que heu d\'inserir: (copieu-lo i aferreu-lo a totes les pàgines)</p>',
	'Installation_Congratulations' => 'Felicitats',
	'Installation_CongratulationsHelp' => '<p>Felicitats! La instal&middot;lació del Intranet Statistics ha finalitzat.</p><p>Assegureu-vos que heu inserit el codi JavaScript a totes les pàgines, i espereu els vostres primers visitants!</p>',
	'Installation_GoToPiwik' => 'Vés al Intranet Statistics',
	...
	'Installation_TablesWarning' => 'Algunes <span id="linkToggle">taules del Intranet Statistics</span> ja estan instal&middot;lades a la base de dades',
	...
	'Installation_TablesDeleteConfirm' => 'Realment voleu esborrar les taules del Intranet Statistics existents en aquesta base de dades?',
	...
	'Installation_JsTagArchivingHelp' => 'Per a llocs amb un tràfic mitjà o alt, visiteu <a target="" href="http://piwik.org/docs/setup-auto-archiving/">Com configurar una pàgina d\'autoarxivació (en anglès)</a> per tal que el Intranet Statistics vagi realment ràpid!',
