...
$translations = array(
	...
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s je k dispozícií. %2$s Prosím vykonajte aktualizáciu!%3$s (pozrite %4$s zmeny%5$s).',
	...
	'CoreHome_NoPrivileges' => 'Ste prihlásený ako \'%s\', ale zdá sa, že nemáte žiadne práva na nastavovanie Intranet Statistics.<br />Požiadajte svojho Intranet Statistics administrátora, aby vám dal prístup na prezeranie(\'view\') k webstránke.',
	...
	'CoreUpdater_UpdateTitle' => 'Intranet Statistics &rsaquo; Aktualizácia',
	...
	'CoreUpdater_PiwikWillBeUpgradedToVersionX' => 'Intranet Statistics bude zaktualizovaný na verziu %s.',
...
',
	...
	'Installation_JsTagHelp' => '<p>Na spočítanie všetkých vašich návštevníkov musíte vložiť do svojich stránok javascript kód.</p><p>Vaše stránky nemusia byť vytvorené v PHP, Intranet Statistics bude fungovať na všetkých typoch stránok (či už to bude HTML, ASP, Perl alebo iný jazyk).</p><p>Tu je kód, ktorý musíte použiť: (skopírujte a vložte ho do svojich stránok)</p>',
	...
	'Installation_TablesWarning' => 'Niektoré <span id="linkToggle">Intranet Statistics tabuľky</span> už existujú v databáze',
