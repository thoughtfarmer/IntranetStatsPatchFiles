...
$translations = array(
	...
	'General_BackToHomepage' => 'กลับไปยังหน้าหลักของ Intranet Statistics',
	'General_Yes' => 'ใช่',
	'General_No' => 'ไม่ใช่',
	'General_Delete' => 'ลบ',
	'General_Edit' => 'แก้ไข',
	...
	'General_PiwikIsACollaborativeProject' => '%sIntranet Statistics%s เป็นโครงการร่วมกันทำและยังเป็นเวอร์ชั่นเบต้าอยู่ %s หากคุณต้องการช่วยเหลือโปรด %s ติดต่อเรา %s',
	'General_YouAreCurrentlyViewingDemoOfPiwik' => 'คุณกำลังดูตัวอย่างของ %s; %sดาวโหลด%s เวอร์ชั่นเต็ม! หรือไม่ %s',
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s ออกแล้ว %2$s กรุณาอัพเดทเดี๋ยวนี้ %3$s (ดู %4$s การเปลี่ยนแปลง %5$s)',
	...
	'CoreHome_NoPrivileges' => 'คุณกำลังเข้าสู่ระบบในฐานะ \'%s\' แต่ดูเหมือนว่าคุณไม่ได้รับสิทธิ์ใดๆที่กำหนดไว้ใน Intranet Statistics. <br />ถามผู้ดูแลระบบ Intranet Statistics ของคุณเพื่อให้คุณ \'view\' การเข้าถึงเว็บไซต์',
	...
	'CorePluginsAdmin_MainDescription' => 'อธิบายปลั้กอินและแสดงการทำงานของ Intranet Statistics เมื่อปลั๊กอินที่ติดตั้งอยู่คุณสามารถเปิดใช้งานหรือยกเลิกการใช้งานได้ ที่นี่',
	...
	'CoreUpdater_UpdateTitle' => 'Intranet Statistics &rsaquo; อัพเดท',
	'CoreUpdater_DatabaseUpgradeRequired' => 'จำเป็นต้องอัพเกรดฐานข้อมูล',
	'CoreUpdater_YourDatabaseIsOutOfDate' => 'ฐานข้อมูล Intranet Statistics ของคุณไม่อัพเดท จำเป็นที่จะต้องอัพเกรดก่อนจึงจะสามารถใช้งานได้',
	...
	'CoreUpdater_PiwikHasBeenSuccessfullyUpgraded' => 'Intranet Statistics ได้รับการปรับปรุงเรียบร้อยแล้ว',
	'CoreUpdater_ContinueToPiwik' => 'ต่อไปยัง Intranet Statistics',
	'CoreUpdater_UpdateAutomatically' => 'ปรับปรุงอัตโนมัติ',
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'มีเวอร์ชั่นของ Intranet Statistics ใหม่ รอให้คุณอัพเดท ',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics อัพเดทสมบูรณ์แล้ว',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'การอัพเดท Intranet Statistics ในคลิกเดียวถูกยกเลิกแล้ว หากคุณไม่สามารถแก้ไขข้อความข้อผิดพลาด แนะนำให้คุณอัพเดท Intranet Statistics แบบ Manual %1$s กรุณาตรวจสอบ %2$s เอกสารการอัพเดท %3$s เพื่อเริ่มดำเนินการ',
	'DBStats_DatabaseUsage' => 'ปริมาณการใช้ฐานข้อมูล',
	'DBStats_MainDescription' => 'Intranet Statistics กำลังเก็บข้อมูลการวิเคราห์เว็บไซต์ของคุณในฐานข้อมูล MySQL ขณะนี้ตารางของ Intranet Statistics กำลังใช้งาน %s',
	'DBStats_Table' => 'ตาราง',
	...
	'Installation_NoConfigFound' => ' ไม่พบไฟล์กำหนดค่าคอนฟิก Intranet Statistics และคุณกำลังพยายามเข้าถึงหน้า Intranet Statistics. <br /> <b> >&nbsp;&nbsp;&raquo; คุณสามารถ<a href=\'index.php\'> ติดตั้ง Intranet Statistics ทันที </ a ></ b> <br /> <small> หากคุณติดตั้ง Intranet Statistics ก่อนและมีตารางในฐานข้อมูลของคุณไม่ต้องกังวลใจคุณสามารถซ้ำเดียวกันตารางและให้ข้อมูลที่มีอยู่ของคุณ! </ small>',
	...
	'Installation_JsTagHelp' => '<p>เพื่อนับจำนวนผู้เยื่ยมชมทั้งหมด คุณจะต้องนำโค้คจาวาสคริป ติดตั้งในทุกหน้าของเว็บไซต์คุณ</p><p>หน้าเพจของคุณไม่ได้ทำจาก PHP, Intranet Statistics สามารถทำงานได้กับเว็บเพจทุกชนิด (ไม่ว่าจะเป็น HTML, ASP, Perl หรือภาษาอื่นๆ)นี่คือโค้ดที่คุณจำเป็นต้องใส่ (คัดลอกแล้ววางลงทุกหน้าเพจทุกหน้าของคุณ</p>',
	'Installation_Congratulations' => 'ยิดดีด้วยสำเร็จแล้ว',
	'Installation_CongratulationsHelp' => '<p>ยินดีด้วยที่การติดตั้ง Intranet Statistics ของคุณเสร็จสมบูรณ์แล้ว</p>
...
<p>กรุณาแน่ใจว่า โค้ดจาวาสคริป ได้ติดตั้งลงบนเว็บเพจของคุณ และรอผู้เยี่ยมชมคนแรกของคุณ</p>',
	...
	'Installation_SecurityNewsletter' => 'ส่งอีเมลล์ให้ฉัน หากมีการอัพเกรด Intranet Statistics หลักและคำเตือนเกี่ยวกับระบบรักษาความปลอดภัย',
...
ดูที่คำสั่ง max_execution_time ในไฟลล์ php.ini หากต้องการ',
	...
	'Installation_TablesWarning' => '<span id="linkToggle">บางตัวในตาราง Intranet Statistics </span>ถูกติดตั้งใน DB แล้ว',
	...
	'Installation_WelcomeHelp' => '<p>Intranet Statistics เป็นโปรแกรมวิเคราห์เว็บไซต์โอเพ่นซอร์ส ซึ่งจะทำให้คุณได้รับข้อมูลจากผู้เยี่ยมชมของคุณอย่างง่ายดาย </p><p>กระบวนการจะแบ่งเป็น %s ขั้นตอนง่ายๆ และจะใช้เวลาประมาณ 5 นาที </p>',
	...
	'Login_ContactAdmin' => 'ปัญหาอาจเกิดจากโฮสของคุณปิดฟังก์ชั่น Mail()<br /> กรุณาติดต่อ Intranet Statistics Administrator ของคุณ',
	...
	'UsersManager_ExceptionEditAnonymous' => 'ผู้ใช้งานที่ไม่ระบุชื่อไม่สามารถแก้ไขหรือลบได้ ,มันถูกใช้งานโดย Intranet Statistics เพื่อระบุผู้ใช้ที่ไม่ได้เข้าสู่ระบบยัง ตัวอย่างเช่นคุณสามารถอนุญาติให้ผู้ใช้งานทั่วไปสามารถดูสถิติของเว็บคุณได้',
