...
$translations = array(
	...
	'General_BackToHomepage' => 'На хатнюю старонку Intranet Statistics',
	'General_Yes' => 'Так',
	'General_No' => 'Не',
	...
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s даступны для спампоўкі. %2$s Калі ласка, абновіцеся!%3$s (гл. %4$s змены%5$s).',
	...
	'CorePluginsAdmin_MainDescription' => 'Убудовы пашыраюць функцыянальнасць Intranet Statistics. Пасля ўсталёўкі ўбудовы Вы можаце актываваць ці дэактываваць яго тут.',
	...
	'API_QuickDocumentation' => '<h2>Кароткая API дакументацыя</h2><p>Калі вы не маеце дадзеных на сёння, вы можаце спачатку <a href=\'misc/generateVisits.php\' target=_blank>згенераваць некаторыя дадзеныя</a>, выкарыстоўваючы скрыпт генерацыі наведванняў.</p><p>Вы можаце выкарыстоўваць розныя фарматы для кожнага метаду. Выключыць неабходную інфармацыю з Intranet Statistics вельмі лёгка!</p><p><b>Для далейшай інфармацыі чытайце <a href=\'http://dev.piwik.org/trac/wiki/API\'>афіцыйную API Дакументацыю</a>, ці <a href=\'http://dev.piwik.org/trac/wiki/API/Reference\'>API Reference</a>.</b></P><h2>Аўтэнтыфікацыя карыстачоў</h2><p>Калі вам неабходна <b>запытваць дадзеныя ў вашых скрыптах, cron-задачах і г.д.</b>, то вам неабходна дадаць параметр <code><u>&token_auth=%s</u></code> да URL API-выкліку, які патрабуе аўтэнтыфікацыю. </p><p>Гэты параметр token_auth такі ж сакрэтны, як і ваш пароль, <b>НЕ ПАВЕДАМЛЯЙЦЕ ЯГО НІКОМУ!</p>',
	'API_LoadedAPIs' => '%s API паспяхова загружана',
	'CoreHome_NoPrivileges' => 'Вы зайшлі як \'%s\', але, падобна, Вы не маеце дазволаў праглядаць статыстыку Intranet Statistics.<br />Паведаміце адміністратару пра падаванне Вам доступу на выкарыстанне сістэмы.',
	...
	'CoreUpdater_UpdateTitle' => 'Intranet Statistics &rsaquo; - абнаўленне',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Ананімны карыстач не можа быць выдалены. Ён неабходзен Intranet Statistics для ідэнтыфікацыі карыстачоў, якія не ўвайшлі ў сістэму. Дапушчальны, вы можаце зрабіць статыстыку публічнай, падаючы права \'Прагляд\' ананімнаму карыстачу.',
	...
	'Installation_NoConfigFound' => 'Канфігурацыйны файл Intranet Statistics не можа быць знойдзены, аднак вы спрабуеце зайсці ў сістэму.<br /><b>&nbsp;&nbsp;&raquo; Вы можаце <a href=\'index.php\'>усталяваць Intranet Statistics цяпер</a></b><br /><small>. Калі Intranet Statistics ужо быў усталяваны і вы маеце дадзеныя ў БД, вы можаце выкарыстоўваць іх.</small>',
	...
	'Installation_JsTagHelp' => '<p>Для падліку наведвальнікаў вы павінны ўставіць дадзены JavaScript-код на ўсе старонкі сайта.</p><p>Код не павінен месцавацца ў PHP, Intranet Statistics будзе працаваць на ўсіх тыпах старонак (уключаючы HTML, ASP, Perl ці любая іншая мова).</p><p>Вось сам код, які неабходна ўставіць(скапіюйце і ўстаўце на ўсе свае старонкі):</p>',
	...
	'Installation_SecurityNewsletter' => 'паведамляць мне пра значныя абнаўленні Intranet Statistics і памылках бяспекі па email',
