...
$translations = array(
	...
	'General_AllowPiwikArchivingToTriggerBrowser' => 'Tillad at udføre Intranet Statistics-arkivering når rapporter vises i netlæseren',
	'General_ArchivingInlineHelp' => 'For hjemmesider med medium til høj trafik anbefales det at deaktivere Intranet Statistics-arkivering udløst fra netlæseren. I stedet anbefales det at køre et cron job hver time til at behandle Intranet Statistics rapporter.',
	...
	'General_RequiresFlash' => 'Visning af grafer i Intranet Statistics kræver Flash',
	'General_GraphHelp' => 'Flere oplysninger om visning af grafer i Intranet Statistics.',
	...
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s er tilgængelig. %2$s Opdater nu!%3$s (se %4$s ændringer%5$s).',
	'General_PiwikXIsAvailablePleaseNotifyPiwikAdmin' => '%s er tilgængelig. Underet administratoren.',
	'General_NewReportsWillBeProcessedByCron' => ' Når Intranet Statistics arkivering ikke udløses af netlæseren, vil nye rapporter blive behandlet af crontab.',
	...
	'General_ConfigFileIsNotWritable' => 'Intranet Statistics konfigurationsfilen %s er skrivebeskyttet, nogle af ændringerne vil ikke blive gemt. %s Skift tilladelser til konfigurationsfilen for at gøre den skrivbar.',
	...
	'CoreHome_NoPrivileges' => 'Du er logget på som \'%s\' men det ser ikke ud som du har adgang til Intranet Statistics.<br />Spørg Intranet Statistics administrator om læseadgang.',
	'CoreHome_JavascriptDisabled' => 'JavaSript skal være aktiveret for at Intranet Statistics kan bruges i standardvisning. JavaScript er enten deaktiver eller ikke understøttet i netlæseren.<br />For at bruge standardvisning, aktiver JavaScript i indstillingerne for netlæseren, og %1$s prøv igen %2$s.<br />',
	...
	'CoreUpdater_TheUpgradeProcessMayFailExecuteCommand' => 'Hvis du har en stor Intranet Statistics database, kan opdateringer tage for lang tid at køre i netlæseren. I denne situation, kan du udføre opdateringen fra kommandolinjen: %s',
	...
	'ExampleUI_PluginDescription' => 'Programudvidelse eksempel: programudvidelsen viser, hvordan man arbejder med Intranet Statistics UI: opretter tabeller, grafer osv.',
	...
	'Goals_LearnMoreAboutGoalTrackingDocumentation' => 'Lær mere om %s Spor mål i Intranet Statistics%s i brugerdokumentationen.',
	...
	'Installation_JsTagArchivingHelp' => 'Hjemmesider med medium og høj trafik se: <a target="_blank" href="http://piwik.org/docs/setup-auto-archiving/">How to setup auto archiving page</a> og få Intranet Statistics til at køre rigtig hurtigt!',
	...
	'Installation_SystemCheckGlobHelp' => 'This built-in function has been disabled on your host. Intranet Statistics may work without this function but at reduced functionality/capability.',
	...
	'MultiSites_PluginDescription' => 'Viser multi-site resumé/statistik. Vedligeholdes som et kerne Intranet Statistics programudvidelse.',
	...
	'SitesManager_PluginDescription' => 'Hjemmeside styring i Intranet Statistics: Tilføj en ny hjemmeside, rediger en eksisterende, vis JavaScript-koden til at inkludere på siderne. Alle handlinger er også tilgængelige via API.',
	...
	'UsersManager_ExceptionEditAnonymous' => 'Anonyme brugere kan ikke redigeres eller slettet. Anvendes af Intranet Statistics til at definere en bruger, som ikke er blevet logget på endnu. For eksempel kan du gøre statistikken offentlig ved at give \'se\' adgang til \'anonym\' bruger',
	...
	'VisitTime_NHour' => '%s',
	'Widgetize_PluginDescription' => 'Programudvidelsen gør det nemt at eksportere Intranet Statistics kontroller til blogs, hjemmeside eller på iGoogle og Netvibes!',
	...
	'PDFReports_PiwikReports' => 'Intranet Statistics raporter',
