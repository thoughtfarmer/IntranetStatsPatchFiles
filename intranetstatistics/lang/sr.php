...
$translations = array(
	...
	'General_PiwikXIsAvailablePleaseUpdateNow' => 'Intranet Statistics %1$s je izašao. %2$s Molimo Vas da odmah izvršite update!%3$s (pogledajte %4$s promene%5$s).',
	...
	'CoreUpdater_PiwikWillBeUpgradedFromVersionXToVersionY' => 'Intranet Statistics baza će biti nadograđen sa verzije %1$s na %2$s.',
	...
	'CoreUpdater_UpgradePiwik' => 'Update Intranet Statistics-a',
	...
	'CoreUpdater_ThereIsNewVersionAvailableForUpdate' => 'Izašla je nova verzija Intranet Statistics-a za update',
	'CoreUpdater_YouCanUpgradeAutomaticallyOrDownloadPackage' => 'Možete izvršiti automatski update na verziju %s ili preuzeti poslednju verziju Intranet Statistics-a i izvršiti manuelni update',
	'CoreUpdater_DownloadX' => 'Download %s',
	'CoreUpdater_UpdateHasBeenCancelledExplanation' => 'Automatski update Intranet Statistics-a je prekinut. Ako ne možete popraviti grešku iznad, preporučljivo je da manuelno izvršite update. %1$s MOlimo Vas da prpverite %2$sdokumentaciju za update%3$s!',
	...
	'CoreUpdater_PiwikUpdatedSuccessfully' => 'Intranet Statistics je updaze-ovan uspešno!',
	...
	'Login_ContactAdmin' => 'Mogući razlog: vaš hosting provajder je možda onemogućio mail() funkciju. <br />Molimo vas da kontaktirate vašeg Intranet Statistics administratora.',
	...
	'UsersManager_ExceptionSuperUser' => 'Traženi korisnik je Super korisnik i kao takav ne može biti pozvan, promenjen ili obrisan putem API-ja. Možete manuelno promeniti podatke Super korisnika u vašem Intranet Statistics konfiguracionom fajlu.',
	...
	'Installation_JsTagHelp' => '<p>Da biste prikupili podatke o svim posetama vašeg web sajta morate ubaciti JavaScript kod na sve stranice.</p><p>Stranice ne moraju biti pisane u jeziku PHP, Intranet Statistics će raditi sa svim vrstama stranica bez obzira da li su one pisane u HTML, ASP, Perl ili nekom drugom jeziku.</p><p>Ovo je JavaScript kod koji morate ubaciti (iskopirajte i ubacite ga na sve stranice vašeg web sajta): </p>',
	'Installation_Congratulations' => 'Čestitamo',
	'Installation_CongratulationsHelp' => '<p>Čestitamo! Intranet Statistics instalacija je završena.</p><p>Postarajte se da je JavaScript kod ubačen na sve stranice web sajta i sačekajte vaše prve posetioce!</p>',
	...
	'Installation_SecurityNewsletter' => 'pošaljite mi email sa važnim Intranet Statistics nadogradnjama i sigurnosim upozorenjima',
	'Installation_CommunityNewsletter' => 'pošaljite mi email sa nadogradnjama od strane Intranet Statistics zajednice (novi dodaci, nove opcije, itd.)',
	'Installation_PasswordDoNotMatch' => 'lozinke se ne podudaraju',
	'Installation_SubmitGo' => 'Napred!',
	'Installation_Requirements' => 'Intranet Statistics potrebe',
	...
	'Installation_TablesWithSameNamesFound' => 'Neke %1$s tabele u vašoj bazi %2$s imaju ista imena kao i tabele od Intranet Statistics-a',
	...
	'Installation_ErrorInvalidState' => 'Greška: izgleda da ste pokušali da preskočite korak u instalalciji, ili vam je podrška za cookie onemogućena u vašem web čitaču, ili je Intranet Statistics-ov konfiguracioni fajl već kreiran. %1$sBudite sigurni da je podrška za cookie omogućena%2$s i vratite se nazad %3$s na prvu stranicu instalacije Intranet Statistics-a %4$s.',
